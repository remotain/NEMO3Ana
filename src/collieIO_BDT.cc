...
int main(int argc, char* argv[]) {
    ...
    /*  2 */ double Cd116_Bi212_weight    = 2.74493           ; TH1D *  Cd116_Bi212       = 0 ; int Cd116_Bi212_i    ; if(  Cd116_Bi212_weight    != 0  ) { Cd116_Bi212      = (TH1D *) infile->Get("Cd116_Bi212_MVA_BDT"    ) -> Clone( "Cd116_Bi212"    ) ; Cd116_Bi212    -> Sumw2() ; Cd116_Bi212    -> Scale( Cd116_Bi212_weight     / Cd116_Bi212     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi212"   ); vbkgd.push_back( Cd116_Bi212    ); Cd116_Bi212_i    = index; index++; };
    /*  3 */ double Cd116_Bi214_weight    = 18.2853           ; TH1D *  Cd116_Bi214       = 0 ; int Cd116_Bi214_i    ; if(  Cd116_Bi214_weight    != 0  ) { Cd116_Bi214      = (TH1D *) infile->Get("Cd116_Bi214_MVA_BDT"    ) -> Clone( "Cd116_Bi214"    ) ; Cd116_Bi214    -> Sumw2() ; Cd116_Bi214    -> Scale( Cd116_Bi214_weight     / Cd116_Bi214     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi214"   ); vbkgd.push_back( Cd116_Bi214    ); Cd116_Bi214_i    = index; index++; };
    ...
    /* 18 */ double SFoil_Pb214_weight    = 0.215627+0.188876 ; TH1D *  SFoil_Pb214       = 0 ; int SFoil_Pb214_i    ; if(  SFoil_Pb214_weight    != 0  ) { SFoil_Pb214      = (TH1D *) infile->Get("SFoil_Pb214_MVA_BDT"    ) -> Clone( "SFoil_Pb214"    ) ; SFoil_Pb214    -> Sumw2() ; SFoil_Pb214    -> Scale( SFoil_Pb214_weight     / SFoil_Pb214     ->Integral() ) ; bkgdNames.push_back("SFoil_Pb214"   ); vbkgd.push_back( SFoil_Pb214    ); SFoil_Pb214_i    = index; index++; };
    ...
    /* 23 */ double Air_Bi214_P1_weight   = 4.19271           ; TH1D *  Air_Bi214_P1      = 0 ; int Air_Bi214_P1_i   ; if(  Air_Bi214_P1_weight   != 0  ) { Air_Bi214_P1     = (TH1D *) infile->Get("Air_Bi214_MVA_BDT"      ) -> Clone( "Air_Bi214_P1"   ) ; Air_Bi214_P1   -> Sumw2() ; Air_Bi214_P1   -> Scale( Air_Bi214_P1_weight    / Air_Bi214_P1    ->Integral() ) ; bkgdNames.push_back("Air_Bi214_P1"  ); vbkgd.push_back( Air_Bi214_P1   ); Air_Bi214_P1_i   = index; index++; };
    ...
    /* 25 */ double PMT_Bi214_weight      = 30.7385           ; TH1D *  PMT_Bi214         = 0 ; int PMT_Bi214_i      ; if(  PMT_Bi214_weight      != 0  ) { PMT_Bi214        = (TH1D *) infile->Get("PMT_Bi214_MVA_BDT"      ) -> Clone( "PMT_Bi214"      ) ; PMT_Bi214      -> Sumw2() ; PMT_Bi214      -> Scale( PMT_Bi214_weight       / PMT_Bi214       ->Integral() ) ; bkgdNames.push_back("PMT_Bi214"     ); vbkgd.push_back( PMT_Bi214      ); PMT_Bi214_i      = index; index++; };
    /* 26 */ double PMT_Tl208_weight      = 23.2701           ; TH1D *  PMT_Tl208         = 0 ; int PMT_Tl208_i      ; if(  PMT_Tl208_weight      != 0  ) { PMT_Tl208        = (TH1D *) infile->Get("PMT_Tl208_MVA_BDT"      ) -> Clone( "PMT_Tl208"      ) ; PMT_Tl208      -> Sumw2() ; PMT_Tl208      -> Scale( PMT_Tl208_weight       / PMT_Tl208       ->Integral() ) ; bkgdNames.push_back("PMT_Tl208"     ); vbkgd.push_back( PMT_Tl208      ); PMT_Tl208_i      = index; index++; };
    /* 27 */ double PMT_Ac228_weight      = 3.60944           ; TH1D *  PMT_Ac228         = 0 ; int PMT_Ac228_i      ; if(  PMT_Ac228_weight      != 0  ) { PMT_Ac228        = (TH1D *) infile->Get("PMT_Ac228_MVA_BDT"      ) -> Clone( "PMT_Ac228"      ) ; PMT_Ac228      -> Sumw2() ; PMT_Ac228      -> Scale( PMT_Ac228_weight       / PMT_Ac228       ->Integral() ) ; bkgdNames.push_back("PMT_Ac228"     ); vbkgd.push_back( PMT_Ac228      ); PMT_Ac228_i      = index; index++; };
    /* 28 */ double PMT_K40_weight        = 16.7905           ; TH1D *  PMT_K40           = 0 ; int PMT_K40_i        ; if(  PMT_K40_weight        != 0  ) { PMT_K40          = (TH1D *) infile->Get("PMT_K40_MVA_BDT"        ) -> Clone( "PMT_K40"        ) ; PMT_K40        -> Sumw2() ; PMT_K40        -> Scale( PMT_K40_weight         / PMT_K40         ->Integral() ) ; bkgdNames.push_back("PMT_K40"       ); vbkgd.push_back( PMT_K40        ); PMT_K40_i        = index; index++; };
    ...
    /* 30 */ double ScintOut_K40_weight   = 0.604003          ; TH1D *  ScintOut_K40      = 0 ; int ScintOut_K40_i   ; if(  ScintOut_K40_weight   != 0  ) { ScintOut_K40     = (TH1D *) infile->Get("ScintOut_K40_MVA_BDT"   ) -> Clone( "ScintOut_K40"   ) ; ScintOut_K40   -> Sumw2() ; ScintOut_K40   -> Scale( ScintOut_K40_weight    / ScintOut_K40    ->Integral() ) ; bkgdNames.push_back("ScintOut_K40"  ); vbkgd.push_back( ScintOut_K40   ); ScintOut_K40_i   = index; index++; };
	...
	/*  7 */ if( Cd116_K40       ) {cfile->createFlatBkgdSystematic( Cd116_K40_i      , "Internal"   , 0.0168 , 0.0098 ,100);};
	/*  8 */ if( Cd116_Pa234m    ) {cfile->createFlatBkgdSystematic( Cd116_Pa234m_i   , "Internal"   , 0.0168 , 0.0098 ,100);};
	/*  9 */ if( SFoil_Bi210     ) {cfile->createFlatBkgdSystematic( SFoil_Bi210_i    , "Internal"   , 0.0168 , 0.0098 ,100);};
	/* 10 */ if( SWire_Bi210     ) {cfile->createFlatBkgdSystematic( SWire_Bi210_i    , "Internal"   , 0.0168 , 0.0098 ,100);};
	/* 11 */ if( SScin_Bi210     ) {cfile->createFlatBkgdSystematic( SScin_Bi210_i    , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 12 */ if( SScin_Bi214     ) {cfile->createFlatBkgdSystematic( SScin_Bi214_i    , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 13 */ if( SScin_Pb214     ) {cfile->createFlatBkgdSystematic( SScin_Pb214_i    , "Externals"  , 0.0131 , 0.0061 ,100);};
	...
	/* 19 */ if( FeShield_Bi214  ) {cfile->createFlatBkgdSystematic( FeShield_Bi214_i , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 20 */ if( FeShield_Tl208  ) {cfile->createFlatBkgdSystematic( FeShield_Tl208_i , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 21 */ if( FeShield_Ac228  ) {cfile->createFlatBkgdSystematic( FeShield_Ac228_i , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 22 */ if( CuTower_Co60    ) {cfile->createFlatBkgdSystematic( CuTower_Co60_i   , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 23 */ if( Air_Bi214_P1    ) {cfile->createFlatBkgdSystematic( Air_Bi214_P1_i   , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 24 */ if( Air_Tl208_P1    ) {cfile->createFlatBkgdSystematic( Air_Tl208_P1_i   , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 25 */ if( PMT_Bi214       ) {cfile->createFlatBkgdSystematic( PMT_Bi214_i      , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 26 */ if( PMT_Tl208       ) {cfile->createFlatBkgdSystematic( PMT_Tl208_i      , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 27 */ if( PMT_Ac228       ) {cfile->createFlatBkgdSystematic( PMT_Ac228_i      , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 28 */ if( PMT_K40         ) {cfile->createFlatBkgdSystematic( PMT_K40_i        , "Externals"  , 0.0131 , 0.0061 ,100);};
	/* 29 */ if( ScintInn_K40    ) {cfile->createFlatBkgdSystematic( ScintInn_K40_i   , "Externals"  , 0.0131 , 0.0061 ,100);};
