...
int main(int argc, char* argv[]) {
    ...
    TH1D * SFoil_Bi210_warm  = (TH1D*) infile->Get("SFoil_Bi210_MVA_BDT")    ; SFoil_Bi210_warm  -> Sumw2() ; SFoil_Bi210_warm  -> Scale( 23.2433   / SFoil_Bi210_warm  -> Integral() ); bkgdNames.push_back( "SuperficeFoglio_Bi210_warm"  ); vbkgd.push_back( SFoil_Bi210_warm  );    
