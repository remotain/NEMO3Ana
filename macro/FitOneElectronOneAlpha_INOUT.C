{
	...
	DataManagement::AddParameter( new Parameter( "SScin_Bi214" , "SScin_Bi214" , 2 , 0.2910 , 0.001 ) ); DataManagement::FindParameter( "SScin_Bi214_P1" ) -> SetFix(); //SetLimit(0.1, 10.);
	//////////////////////////////////////////////////////////////////////////////
	//
	// Define the parameters P1
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_IN_P1"  , "SFoil_Bi214_IN_P1"  , 3 , 0.080 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_IN_P1"  ) -> SetLimit(0., 5.);
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_OUT_P1" , "SFoil_Bi214_OUT_P1" , 4 , 0.080 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_OUT_P1" ) -> SetLimit(0., 5.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_IN_P1"  , "SWire_Bi214_IN_P1"  , 5 , 0.198 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_IN_P1"  ) -> SetLimit(0., 1.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_OUT_P1" , "SWire_Bi214_OUT_P1" , 6 , 0.198 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_OUT_P1" ) -> SetLimit(0., 1.);
	//////////////////////////////////////////////////////////////////////////////
	//
	// Define the parameters P2
	//
	//////////////////////////////////////////////////////////////////////////////		
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_IN_P2"  , "SFoil_Bi214_IN_P2"  ,  7 , 0.020 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_IN_P2"  ) -> SetLimit(0., 5.);
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_OUT_P2" , "SFoil_Bi214_OUT_P2" ,  8 , 0.020 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_OUT_P2" ) -> SetLimit(0., 5.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_IN_P2"  , "SWire_Bi214_IN_P2"  ,  9 , 0.198 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_IN_P2"  ) -> SetLimit(0., 5.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_OUT_P2" , "SWire_Bi214_OUT_P2" , 10 , 0.198 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_OUT_P2" ) -> SetLimit(0., 5.);
	//////////////////////////////////////////////////////////////////////////////
	//
