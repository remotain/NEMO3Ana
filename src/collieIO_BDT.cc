...
int main(int argc, char* argv[]) {
    ...
    /*  0 */ double Cd116_Tl208_weight    = 5.93241           ; TH1D *  Cd116_Tl208       = 0 ; int Cd116_Tl208_i    ; if(  Cd116_Tl208_weight    != 0  ) { Cd116_Tl208      = (TH1D *) infile->Get("Cd116_Tl208_MVA_BDT"    ) -> Clone( "Cd116_Tl208"    ) ; Cd116_Tl208    -> Sumw2() ; Cd116_Tl208    -> Scale( Cd116_Tl208_weight     / Cd116_Tl208     ->Integral() ) ; bkgdNames.push_back("Cd116_Tl208"   ); vbkgd.push_back( Cd116_Tl208    ); Cd116_Tl208_i    = index+1; };
    /*  1 */ double Cd116_Ac228_weight    = 6.92004           ; TH1D *  Cd116_Ac228       = 0 ; int Cd116_Ac228_i    ; if(  Cd116_Ac228_weight    != 0  ) { Cd116_Ac228      = (TH1D *) infile->Get("Cd116_Ac228_MVA_BDT"    ) -> Clone( "Cd116_Ac228"    ) ; Cd116_Ac228    -> Sumw2() ; Cd116_Ac228    -> Scale( Cd116_Ac228_weight     / Cd116_Ac228     ->Integral() ) ; bkgdNames.push_back("Cd116_Ac228"   ); vbkgd.push_back( Cd116_Ac228    ); Cd116_Ac228_i    = index+1; };
    /*  2 */ double Cd116_Bi212_weight    = 2.74493           ; TH1D *  Cd116_Bi212       = 0 ; int Cd116_Bi212_i    ; if(  Cd116_Bi212_weight    != 0  ) { Cd116_Bi212      = (TH1D *) infile->Get("Cd116_Bi212_MVA_BDT"    ) -> Clone( "Cd116_Bi212"    ) ; Cd116_Bi212    -> Sumw2() ; Cd116_Bi212    -> Scale( Cd116_Bi212_weight     / Cd116_Bi212     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi212"   ); vbkgd.push_back( Cd116_Bi212    ); Cd116_Bi212_i    = index+1; };
    /*  3 */ double Cd116_Bi214_weight    = 18.2853           ; TH1D *  Cd116_Bi214       = 0 ; int Cd116_Bi214_i    ; if(  Cd116_Bi214_weight    != 0  ) { Cd116_Bi214      = (TH1D *) infile->Get("Cd116_Bi214_MVA_BDT"    ) -> Clone( "Cd116_Bi214"    ) ; Cd116_Bi214    -> Sumw2() ; Cd116_Bi214    -> Scale( Cd116_Bi214_weight     / Cd116_Bi214     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi214"   ); vbkgd.push_back( Cd116_Bi214    ); Cd116_Bi214_i    = index+1; };
    /*  4 */ double Cd116_Pb214_weight    = 0.186478          ; TH1D *  Cd116_Pb214       = 0 ; int Cd116_Pb214_i    ; if(  Cd116_Pb214_weight    != 0  ) { Cd116_Pb214      = (TH1D *) infile->Get("Cd116_Pb214_VT_MVA_BDT" ) -> Clone( "Cd116_Pb214"    ) ; Cd116_Pb214    -> Sumw2() ; Cd116_Pb214    -> Scale( Cd116_Pb214_weight     / Cd116_Pb214     ->Integral() ) ; bkgdNames.push_back("Cd116_Pb214"   ); vbkgd.push_back( Cd116_Pb214    ); Cd116_Pb214_i    = index+1; };
    /*  5 */ double Mylar_Bi214_weight    = 11.1896           ; TH1D *  Mylar_Bi214       = 0 ; int Mylar_Bi214_i    ; if(  Mylar_Bi214_weight    != 0  ) { Mylar_Bi214      = (TH1D *) infile->Get("Mylar_Bi214_MVA_BDT"    ) -> Clone( "Mylar_Bi214"    ) ; Mylar_Bi214    -> Sumw2() ; Mylar_Bi214    -> Scale( Mylar_Bi214_weight     / Mylar_Bi214     ->Integral() ) ; bkgdNames.push_back("Mylar_Bi214"   ); vbkgd.push_back( Mylar_Bi214    ); Mylar_Bi214_i    = index+1; };
    ...
    /* 18 */ double SFoil_Pb214_weight    = 0.215627+0.188876 ; TH1D *  SFoil_Pb214       = 0 ; int SFoil_Pb214_i    ; if(  SFoil_Pb214_weight    != 0  ) { SFoil_Pb214      = (TH1D *) infile->Get("SFoil_Pb214_MVA_BDT"    ) -> Clone( "SFoil_Pb214"    ) ; SFoil_Pb214    -> Sumw2() ; SFoil_Pb214    -> Scale( SFoil_Pb214_weight     / SFoil_Pb214     ->Integral() ) ; bkgdNames.push_back("SFoil_Pb214"   ); vbkgd.push_back( SFoil_Pb214    ); SFoil_Pb214_i    = index+1; };
    /* 19 */ double FeShield_Bi214_weight = 49.1846           ; TH1D *  FeShield_Bi214    = 0 ; int FeShield_Bi214_i ; if(  FeShield_Bi214_weight != 0  ) { FeShield_Bi214   = (TH1D *) infile->Get("FeShield_Bi214_MVA_BDT" ) -> Clone( "FeShield_Bi214" ) ; FeShield_Bi214 -> Sumw2() ; FeShield_Bi214 -> Scale( FeShield_Bi214_weight  / FeShield_Bi214  ->Integral() ) ; bkgdNames.push_back("FeShield_Bi214"); vbkgd.push_back( FeShield_Bi214 ); FeShield_Bi214_i = index+1; };
    /* 20 */ double FeShield_Tl208_weight = 1.19312           ; TH1D *  FeShield_Tl208    = 0 ; int FeShield_Tl208_i ; if(  FeShield_Tl208_weight != 0  ) { FeShield_Tl208   = (TH1D *) infile->Get("FeShield_Tl208_MVA_BDT" ) -> Clone( "FeShield_Tl208" ) ; FeShield_Tl208 -> Sumw2() ; FeShield_Tl208 -> Scale( FeShield_Tl208_weight  / FeShield_Tl208  ->Integral() ) ; bkgdNames.push_back("FeShield_Tl208"); vbkgd.push_back( FeShield_Tl208 ); FeShield_Tl208_i = index+1; };
    /* 21 */ double FeShield_Ac228_weight = 0.17612           ; TH1D *  FeShield_Ac228    = 0 ; int FeShield_Ac228_i ; if(  FeShield_Ac228_weight != 0  ) { FeShield_Ac228   = (TH1D *) infile->Get("FeShield_Ac228_MVA_BDT" ) -> Clone( "FeShield_Ac228" ) ; FeShield_Ac228 -> Sumw2() ; FeShield_Ac228 -> Scale( FeShield_Ac228_weight  / FeShield_Ac228  ->Integral() ) ; bkgdNames.push_back("FeShield_Ac228"); vbkgd.push_back( FeShield_Ac228 ); FeShield_Ac228_i = index+1; };
    /* 22 */ double CuTower_Co60_weight   = 3.77603           ; TH1D *  CuTower_Co60      = 0 ; int CuTower_Co60_i   ; if(  CuTower_Co60_weight   != 0  ) { CuTower_Co60     = (TH1D *) infile->Get("CuTower_Co60_MVA_BDT"   ) -> Clone( "CuTower_Co60"   ) ; CuTower_Co60   -> Sumw2() ; CuTower_Co60   -> Scale( CuTower_Co60_weight    / CuTower_Co60    ->Integral() ) ; bkgdNames.push_back("CuTower_Co60"  ); vbkgd.push_back( CuTower_Co60   ); CuTower_Co60_i   = index+1; };
    /* 23 */ double Air_Bi214_P1_weight   = 4.19271           ; TH1D *  Air_Bi214_P1      = 0 ; int Air_Bi214_P1_i   ; if(  Air_Bi214_P1_weight   != 0  ) { Air_Bi214_P1     = (TH1D *) infile->Get("Air_Bi214_MVA_BDT"      ) -> Clone( "Air_Bi214_P1"   ) ; Air_Bi214_P1   -> Sumw2() ; Air_Bi214_P1   -> Scale( Air_Bi214_P1_weight    / Air_Bi214_P1    ->Integral() ) ; bkgdNames.push_back("Air_Bi214_P1"  ); vbkgd.push_back( Air_Bi214_P1   ); Air_Bi214_P1_i   = index+1; };
    /* 24 */ double Air_Tl208_P1_weight   = 0.                ; TH1D *  Air_Tl208_P1      = 0 ; int Air_Tl208_P1_i   ; if(  Air_Tl208_P1_weight   != 0  ) { Air_Tl208_P1     = (TH1D *) infile->Get("Air_Tl208_MVA_BDT"      ) -> Clone( "Air_Tl208_P1"   ) ; Air_Tl208_P1   -> Sumw2() ; Air_Tl208_P1   -> Scale( Air_Tl208_P1_weight    / Air_Tl208_P1    ->Integral() ) ; bkgdNames.push_back("Air_Tl208_P1"  ); vbkgd.push_back( Air_Tl208_P1   ); Air_Tl208_P1_i   = index+1; };
    /* 25 */ double PMT_Bi214_weight      = 30.7385           ; TH1D *  PMT_Bi214         = 0 ; int PMT_Bi214_i      ; if(  PMT_Bi214_weight      != 0  ) { PMT_Bi214        = (TH1D *) infile->Get("PMT_Bi214_MVA_BDT"      ) -> Clone( "PMT_Bi214"      ) ; PMT_Bi214      -> Sumw2() ; PMT_Bi214      -> Scale( PMT_Bi214_weight       / PMT_Bi214       ->Integral() ) ; bkgdNames.push_back("PMT_Bi214"     ); vbkgd.push_back( PMT_Bi214      ); PMT_Bi214_i      = index+1; };
    /* 26 */ double PMT_Tl208_weight      = 23.2701           ; TH1D *  PMT_Tl208         = 0 ; int PMT_Tl208_i      ; if(  PMT_Tl208_weight      != 0  ) { PMT_Tl208        = (TH1D *) infile->Get("PMT_Tl208_MVA_BDT"      ) -> Clone( "PMT_Tl208"      ) ; PMT_Tl208      -> Sumw2() ; PMT_Tl208      -> Scale( PMT_Tl208_weight       / PMT_Tl208       ->Integral() ) ; bkgdNames.push_back("PMT_Tl208"     ); vbkgd.push_back( PMT_Tl208      ); PMT_Tl208_i      = index+1; };
    /* 27 */ double PMT_Ac228_weight      = 3.60944           ; TH1D *  PMT_Ac228         = 0 ; int PMT_Ac228_i      ; if(  PMT_Ac228_weight      != 0  ) { PMT_Ac228        = (TH1D *) infile->Get("PMT_Ac228_MVA_BDT"      ) -> Clone( "PMT_Ac228"      ) ; PMT_Ac228      -> Sumw2() ; PMT_Ac228      -> Scale( PMT_Ac228_weight       / PMT_Ac228       ->Integral() ) ; bkgdNames.push_back("PMT_Ac228"     ); vbkgd.push_back( PMT_Ac228      ); PMT_Ac228_i      = index+1; };
    /* 28 */ double PMT_K40_weight        = 16.7905           ; TH1D *  PMT_K40           = 0 ; int PMT_K40_i        ; if(  PMT_K40_weight        != 0  ) { PMT_K40          = (TH1D *) infile->Get("PMT_K40_MVA_BDT"        ) -> Clone( "PMT_K40"        ) ; PMT_K40        -> Sumw2() ; PMT_K40        -> Scale( PMT_K40_weight         / PMT_K40         ->Integral() ) ; bkgdNames.push_back("PMT_K40"       ); vbkgd.push_back( PMT_K40        ); PMT_K40_i        = index+1; };
    /* 29 */ double ScintInn_K40_weight   = 0.335557          ; TH1D *  ScintInn_K40      = 0 ; int ScintInn_K40_i   ; if(  ScintInn_K40_weight   != 0  ) { ScintInn_K40     = (TH1D *) infile->Get("ScintInn_K40_MVA_BDT"   ) -> Clone( "ScintInn_K40"   ) ; ScintInn_K40   -> Sumw2() ; ScintInn_K40   -> Scale( ScintInn_K40_weight    / ScintInn_K40    ->Integral() ) ; bkgdNames.push_back("ScintInn_K40"  ); vbkgd.push_back( ScintInn_K40   ); ScintInn_K40_i   = index+1; };
    /* 30 */ double ScintOut_K40_weight   = 0.604003          ; TH1D *  ScintOut_K40      = 0 ; int ScintOut_K40_i   ; if(  ScintOut_K40_weight   != 0  ) { ScintOut_K40     = (TH1D *) infile->Get("ScintOut_K40_MVA_BDT"   ) -> Clone( "ScintOut_K40"   ) ; ScintOut_K40   -> Sumw2() ; ScintOut_K40   -> Scale( ScintOut_K40_weight    / ScintOut_K40    ->Integral() ) ; bkgdNames.push_back("ScintOut_K40"  ); vbkgd.push_back( ScintOut_K40   ); ScintOut_K40_i   = index+1; };
    /* 31 */ double ScintPet_K40_weight   = 1.00666           ; TH1D *  ScintPet_K40      = 0 ; int ScintPet_K40_i   ; if(  ScintPet_K40_weight   != 0  ) { ScintPet_K40     = (TH1D *) infile->Get("ScintPet_K40_MVA_BDT"   ) -> Clone( "ScintPet_K40"   ) ; ScintPet_K40   -> Sumw2() ; ScintPet_K40   -> Scale( ScintPet_K40_weight    / ScintPet_K40    ->Integral() ) ; bkgdNames.push_back("ScintPet_K40"  ); vbkgd.push_back( ScintPet_K40   ); ScintPet_K40_i   = index+1; };
