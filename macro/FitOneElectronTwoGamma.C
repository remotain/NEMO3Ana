{
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "Cd116_Tl208" , "Cd116_Tl208" ,  0 , 0.00017 , 0.001 ) ); 
	DataManagement::AddParameter( new Parameter( "cRnP1" 		   , "cRnP1"   ,  1 , 0.6     , 0.001 ) ); //DataManagement::FindParameter( "cRnP1" ) -> SetFix(); 
	DataManagement::AddParameter( new Parameter( "cRnP2" 		   , "cRnP2"   ,  2 , 0.7     , 0.001 ) ); //DataManagement::FindParameter( "cRnP2" ) -> SetFix(); 
	DataManagement::AddParameter( new Parameter( "cExt" 		   , "cExt"    ,  3 , 1.      , 0.001 ) ); //DataManagement::FindParameter( "cExt"  ) -> SetFix(); 
	//////////////////////////////////////////////////////////////////////////////
	//	
	// Tl Internal
	//
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddComponent( new Component( "Cd116_Bi214" , "^{214}Bi Cd116" , DataManagement::FindDataSet( "Cd116_Bi214" ) , 0.440*2.82801e-04 , 0.440*8.53952e-05 )); DataManagement::FindComponent("Cd116_Bi214")->SetFillColor( kGreen +  0 );
	//////////////////////////////////////////////////////////////////////////////
	//	
	// Bi from Mylar
	//
	//////////////////////////////////////////////////////////////////////////////		
	DataManagement::AddComponent( new Component( "Mylar_Bi214" , "^{214}Bi Mylar" , DataManagement::FindDataSet( "Mylar_Bi214" ) , 0.887680542*3.01073e-03, 0.887680542*2.28492e-04 )); DataManagement::FindComponent( "Mylar_Bi214"   )->SetFillColor( kGreen +  1 );
	//////////////////////////////////////////////////////////////////////////////
	//	
	...
	DataManagement::AddComponent( new Component( "SWire_Bi214_P1_OUT" , "^{214}Bi SWire P1 Out" , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 6.53893e-01 )); DataManagement::FindComponent( "SWire_Bi214_P1_OUT" )->SetFillColor( kAzure +  1 );
	...
	DataManagement::AddComponent( new Component( "SWire_Bi214_P2_OUT" , "^{214}Bi SWire P2 Out" , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.00534e-01 )); DataManagement::FindComponent( "SWire_Bi214_P2_OUT" )->SetFillColor( kAzure +  1 );
	//
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P1_IN"  , "^{214}Bi SFoil P1 In " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.22140e-02 )); DataManagement::FindComponent( "SFoil_Bi214_P1_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P1_OUT" , "^{214}Bi SFoil P1 Out" , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.69628e-02 )); DataManagement::FindComponent( "SFoil_Bi214_P1_OUT" )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P2_IN"  , "^{214}Bi SFoil P2 In " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.14207e-03 )); DataManagement::FindComponent( "SFoil_Bi214_P2_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P2_OUT" , "^{214}Bi SFoil P2 Out" , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.07416e-03 )); DataManagement::FindComponent( "SFoil_Bi214_P2_OUT" )->SetFillColor( kAzure +  1 );	
	//////////////////////////////////////////////////////////////////////////////
	//	
	// Externals
	//
	...
	DataManagement::AddComponent( new Component( "FeShield_Tl208" , "FeShield ^{208}Tl  " , DataManagement::FindDataSet( "FeShield_Tl208" ) , DataManagement::FindParameter( "cExt" ) ,  484.00     )); DataManagement::FindComponent( "FeShield_Tl208" )->SetFillColor( kViolet + 0 );
	DataManagement::AddComponent( new Component( "FeShield_Ac228" , "FeShield ^{228}Ac  " , DataManagement::FindDataSet( "FeShield_Ac228" ) , DataManagement::FindParameter( "cExt" ) ,  484.00     )); DataManagement::FindComponent( "FeShield_Ac228" )->SetFillColor( kViolet + 0 );	
	...
	energy_score_fun_P1 -> Draw();
	energy_score_fun_P2 -> Draw();
	tot_energy_P1       -> Draw();
	tot_energy_P2       -> Draw();
	//e_energy_P1         -> Draw();
	//e_energy_P2         -> Draw();
	glow_energy_P1      -> Draw();
	glow_energy_P2      -> Draw();
	ghigh_energy_P1     -> Draw();	
	ghigh_energy_P2     -> Draw();
