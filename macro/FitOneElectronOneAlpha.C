{
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "Mylar_Bi214_P1" , "Mylar_Bi214_P1" , 0 , 0.001 , 0.001 ) ); DataManagement::FindParameter( "Mylar_Bi214_P1" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_P1" , "SFoil_Bi214_P1" , 1 , 0.001 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_P1" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SScin_Bi214_P1" , "SScin_Bi214_P1" , 2 , 1.001 , 0.001 ) ); DataManagement::FindParameter( "SScin_Bi214_P1" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_P1" , "SWire_Bi214_P1" , 3 , 0.001 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_P1" ) -> SetLimit(0., 10.);
	//////////////////////////////////////////////////////////////////////////////
	//
	// Define the parameters P2
	//
	//////////////////////////////////////////////////////////////////////////////		
	DataManagement::AddParameter( new Parameter( "Mylar_Bi214_P2" , "Mylar_Bi214_P2" ,  4 , 0.001	 , 0.001 ) ); DataManagement::FindParameter( "Mylar_Bi214_P2" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SFoil_Bi214_P2" , "SFoil_Bi214_P2" ,  5 , 0.001	 , 0.001 ) ); DataManagement::FindParameter( "SFoil_Bi214_P2" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SScin_Bi214_P2" , "SScin_Bi214_P2" ,  6 , 1.001	 , 0.001 ) ); DataManagement::FindParameter( "SScin_Bi214_P2" ) -> SetLimit(0., 10.);
	DataManagement::AddParameter( new Parameter( "SWire_Bi214_P2" , "SWire_Bi214_P2" ,  7 , 0.001	 , 0.001 ) ); DataManagement::FindParameter( "SWire_Bi214_P2" ) -> SetLimit(0., 10.);
	//////////////////////////////////////////////////////////////////////////////
	//
	// Define components P1
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P1" , "^{210}B1 Mylar P1   " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214_P1" ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P1" )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P1" , "^{214}B1 SFoil P1   " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "SFoil_Bi214_P1" ) , 1.0 )); DataManagement::FindComponent( "SFoil_Bi214_P1" )->SetFillColor( kAzure +  2 );
	DataManagement::AddComponent( new Component( "SScin_Bi214_P1" , "^{214}B1 SScin P1   " , DataManagement::FindDataSet( "SScin_Bi214" ) , DataManagement::FindParameter( "SScin_Bi214_P1" ) , 1.0 )); DataManagement::FindComponent( "SScin_Bi214_P1" )->SetFillColor( kAzure +  3 );
	...
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P2" , "^{210}B1 Mylar P2   " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214_P2" ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P2" )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P2" , "^{214}B1 SFoil P2   " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "SFoil_Bi214_P2" ) , 1.0 )); DataManagement::FindComponent( "SFoil_Bi214_P2" )->SetFillColor( kAzure +  2 );
	DataManagement::AddComponent( new Component( "SScin_Bi214_P2" , "^{214}B1 SScin P2   " , DataManagement::FindDataSet( "SScin_Bi214" ) , DataManagement::FindParameter( "SScin_Bi214_P2" ) , 1.0 )); DataManagement::FindComponent( "SScin_Bi214_P2" )->SetFillColor( kAzure +  3 );
	...
	Observable * electronEnergy_P1 = new Observable("electronEnergy_P2" , "1e1a - electron energy - Phase 1"    , kPhaseOne , hcoll->Find("Data_h_electronEnergy_P2" ) );
