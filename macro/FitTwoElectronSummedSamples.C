{
	...
	//TFile * f = new TFile("/Users/alberto/Software/SuperNEMO/work/nemo3/plot/plot_20150504/TwoElectronIntHistos_ggNA.root");
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "cBB"       , "cBB"       ,  0 , 3.40985e-01    , 0.0000001 ) ); 
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddObservable( tot_e_energy );	
	//DataManagement::AddObservable( min_e_energy );	
	//DataManagement::AddObservable( max_e_energy );	
	//DataManagement::AddObservable( cosTheta );	
    //
	Fit::DoDrawScan();
	//Fit::DoDrawContour();
	...
	tot_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps(" ); tot_e_energy -> SetLogScale(kTRUE);
    tot_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  );
	min_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  ); min_e_energy -> SetLogScale(kTRUE);
	min_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  );
	max_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  ); max_e_energy -> SetLogScale(kTRUE);
	max_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  );
	cosTheta     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps"  ); cosTheta -> SetLogScale(kTRUE);
	cosTheta     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronSummedSamples.ps)"  );
