...
int main(int argc, char* argv[]) {
    ...
    /*  2 */ double Cd116_Bi212_weight    = 3.0461            ; TH1D *  Cd116_Bi212       = 0 ; int Cd116_Bi212_i    ; if(  Cd116_Bi212_weight    != 0  ) { Cd116_Bi212      = (TH1D *) infile->Get("Cd116_Bi212_MVA_BDT"    ) -> Clone( "Cd116_Bi212"    ) ; Cd116_Bi212    -> Sumw2() ; Cd116_Bi212    -> Scale( Cd116_Bi212_weight     / Cd116_Bi212     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi212"   ); vbkgd.push_back( Cd116_Bi212    ); Cd116_Bi212_i    = index; index++; };
    /*  3 */ double Cd116_Bi214_weight    = 18.2842           ; TH1D *  Cd116_Bi214       = 0 ; int Cd116_Bi214_i    ; if(  Cd116_Bi214_weight    != 0  ) { Cd116_Bi214      = (TH1D *) infile->Get("Cd116_Bi214_MVA_BDT"    ) -> Clone( "Cd116_Bi214"    ) ; Cd116_Bi214    -> Sumw2() ; Cd116_Bi214    -> Scale( Cd116_Bi214_weight     / Cd116_Bi214     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi214"   ); vbkgd.push_back( Cd116_Bi214    ); Cd116_Bi214_i    = index; index++; };
    /*  4 */ double Cd116_Pb214_weight    = 0.186466          ; TH1D *  Cd116_Pb214       = 0 ; int Cd116_Pb214_i    ; if(  Cd116_Pb214_weight    != 0  ) { Cd116_Pb214      = (TH1D *) infile->Get("Cd116_Pb214_VT_MVA_BDT" ) -> Clone( "Cd116_Pb214"    ) ; Cd116_Pb214    -> Sumw2() ; Cd116_Pb214    -> Scale( Cd116_Pb214_weight     / Cd116_Pb214     ->Integral() ) ; bkgdNames.push_back("Cd116_Pb214"   ); vbkgd.push_back( Cd116_Pb214    ); Cd116_Pb214_i    = index; index++; };
    ...
    /* 12 */ double SScin_Bi214_weight    = 0.0510755         ; TH1D *  SScin_Bi214       = 0 ; int SScin_Bi214_i    ; if(  SScin_Bi214_weight    != 0  ) { SScin_Bi214      = (TH1D *) infile->Get("SScin_Bi214_MVA_BDT"    ) -> Clone( "SScin_Bi214"    ) ; SScin_Bi214    -> Sumw2() ; SScin_Bi214    -> Scale( SScin_Bi214_weight     / SScin_Bi214     ->Integral() ) ; bkgdNames.push_back("SScin_Bi214"   ); vbkgd.push_back( SScin_Bi214    ); SScin_Bi214_i    = index; index++; };
    ...
    /* 16 */ double SFoil_Bi214_weight    = 5.8594+2.82835    ; TH1D *  SFoil_Bi214       = 0 ; int SFoil_Bi214_i    ; if(  SFoil_Bi214_weight    != 0  ) { SFoil_Bi214      = (TH1D *) infile->Get("SFoil_Bi214_MVA_BDT"    ) -> Clone( "SFoil_Bi214"    ) ; SFoil_Bi214    -> Sumw2() ; SFoil_Bi214    -> Scale( SFoil_Bi214_weight     / SFoil_Bi214     ->Integral() ) ; bkgdNames.push_back("SFoil_Bi214"   ); vbkgd.push_back( SFoil_Bi214    ); SFoil_Bi214_i    = index; index++; };
    /* 17 */ double SWire_Pb214_weight    = 0.458466+0.649173 ; TH1D *  SWire_Pb214       = 0 ; int SWire_Pb214_i    ; if(  SWire_Pb214_weight    != 0  ) { SWire_Pb214      = (TH1D *) infile->Get("SWire_Pb214_MVA_BDT"    ) -> Clone( "SWire_Pb214"    ) ; SWire_Pb214    -> Sumw2() ; SWire_Pb214    -> Scale( SWire_Pb214_weight     / SWire_Pb214     ->Integral() ) ; bkgdNames.push_back("SWire_Pb214"   ); vbkgd.push_back( SWire_Pb214    ); SWire_Pb214_i    = index; index++; };
    /* 18 */ double SFoil_Pb214_weight    = 0.218757+0.195303 ; TH1D *  SFoil_Pb214       = 0 ; int SFoil_Pb214_i    ; if(  SFoil_Pb214_weight    != 0  ) { SFoil_Pb214      = (TH1D *) infile->Get("SFoil_Pb214_MVA_BDT"    ) -> Clone( "SFoil_Pb214"    ) ; SFoil_Pb214    -> Sumw2() ; SFoil_Pb214    -> Scale( SFoil_Pb214_weight     / SFoil_Pb214     ->Integral() ) ; bkgdNames.push_back("SFoil_Pb214"   ); vbkgd.push_back( SFoil_Pb214    ); SFoil_Pb214_i    = index; index++; };
    ...
    /* 25 */ double PMT_Bi214_weight      = 28.1459           ; TH1D *  PMT_Bi214         = 0 ; int PMT_Bi214_i      ; if(  PMT_Bi214_weight      != 0  ) { PMT_Bi214        = (TH1D *) infile->Get("PMT_Bi214_MVA_BDT"      ) -> Clone( "PMT_Bi214"      ) ; PMT_Bi214      -> Sumw2() ; PMT_Bi214      -> Scale( PMT_Bi214_weight       / PMT_Bi214       ->Integral() ) ; bkgdNames.push_back("PMT_Bi214"     ); vbkgd.push_back( PMT_Bi214      ); PMT_Bi214_i      = index; index++; };
    /* 26 */ double PMT_Tl208_weight      = 23.2553           ; TH1D *  PMT_Tl208         = 0 ; int PMT_Tl208_i      ; if(  PMT_Tl208_weight      != 0  ) { PMT_Tl208        = (TH1D *) infile->Get("PMT_Tl208_MVA_BDT"      ) -> Clone( "PMT_Tl208"      ) ; PMT_Tl208      -> Sumw2() ; PMT_Tl208      -> Scale( PMT_Tl208_weight       / PMT_Tl208       ->Integral() ) ; bkgdNames.push_back("PMT_Tl208"     ); vbkgd.push_back( PMT_Tl208      ); PMT_Tl208_i      = index; index++; };
    /* 27 */ double PMT_Ac228_weight      = 3.60714           ; TH1D *  PMT_Ac228         = 0 ; int PMT_Ac228_i      ; if(  PMT_Ac228_weight      != 0  ) { PMT_Ac228        = (TH1D *) infile->Get("PMT_Ac228_MVA_BDT"      ) -> Clone( "PMT_Ac228"      ) ; PMT_Ac228      -> Sumw2() ; PMT_Ac228      -> Scale( PMT_Ac228_weight       / PMT_Ac228       ->Integral() ) ; bkgdNames.push_back("PMT_Ac228"     ); vbkgd.push_back( PMT_Ac228      ); PMT_Ac228_i      = index; index++; };
    ...
    /* 29 */ double ScintInn_K40_weight   = 0.333992          ; TH1D *  ScintInn_K40      = 0 ; int ScintInn_K40_i   ; if(  ScintInn_K40_weight   != 0  ) { ScintInn_K40     = (TH1D *) infile->Get("ScintInn_K40_MVA_BDT"   ) -> Clone( "ScintInn_K40"   ) ; ScintInn_K40   -> Sumw2() ; ScintInn_K40   -> Scale( ScintInn_K40_weight    / ScintInn_K40    ->Integral() ) ; bkgdNames.push_back("ScintInn_K40"  ); vbkgd.push_back( ScintInn_K40   ); ScintInn_K40_i   = index; index++; };
    /* 30 */ double ScintOut_K40_weight   = 0.601186          ; TH1D *  ScintOut_K40      = 0 ; int ScintOut_K40_i   ; if(  ScintOut_K40_weight   != 0  ) { ScintOut_K40     = (TH1D *) infile->Get("ScintOut_K40_MVA_BDT"   ) -> Clone( "ScintOut_K40"   ) ; ScintOut_K40   -> Sumw2() ; ScintOut_K40   -> Scale( ScintOut_K40_weight    / ScintOut_K40    ->Integral() ) ; bkgdNames.push_back("ScintOut_K40"  ); vbkgd.push_back( ScintOut_K40   ); ScintOut_K40_i   = index; index++; };
    /* 31 */ double ScintPet_K40_weight   = 1.00196           ; TH1D *  ScintPet_K40      = 0 ; int ScintPet_K40_i   ; if(  ScintPet_K40_weight   != 0  ) { ScintPet_K40     = (TH1D *) infile->Get("ScintPet_K40_MVA_BDT"   ) -> Clone( "ScintPet_K40"   ) ; ScintPet_K40   -> Sumw2() ; ScintPet_K40   -> Scale( ScintPet_K40_weight    / ScintPet_K40    ->Integral() ) ; bkgdNames.push_back("ScintPet_K40"  ); vbkgd.push_back( ScintPet_K40   ); ScintPet_K40_i   = index; index++; };
