...
int main(int argc, char* argv[]) {
    ...
    TH1D * Cd116_Pa234m_warm = (TH1D*) infile->Get("Cd116_Pa234m_MVA_BDT")   ; Cd116_Pa234m_warm -> Sumw2() ; Cd116_Pa234m_warm -> Scale( 72.5556   / Cd116_Pa234m_warm -> Integral() ); bkgdNames.push_back( "Cd116_Pa234mw" ); vbkgd.push_back( Cd116_Pa234m_warm );
    TH1D * SFoil_Bi210_warm  = (TH1D*) infile->Get("SFoil_Bi210_MVA_BDT")    ; SFoil_Bi210_warm  -> Sumw2() ; SFoil_Bi210_warm  -> Scale( 23.2433   / SFoil_Bi210_warm  -> Integral() ); bkgdNames.push_back( "SFoil_Bi210w"  ); vbkgd.push_back( SFoil_Bi210_warm  );    
