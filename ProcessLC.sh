...
if [ "${SGE_TASK_ID}" -eq "16" ]; then ${PATH_EXE}/collieLC_m1s ${PATH_OUT}/CollieLC_En_MM_100_m1s.root     ${PATH_OUT}/CollieIO_En_MM_100.root     ; fi
if [ "${SGE_TASK_ID}" -eq "17" ]; then ${PATH_EXE}/collieLC_m1s ${PATH_OUT}/CollieLC_En_RHC_L_100_m1s.root  ${PATH_OUT}/CollieIO_En_RHC_L_100.root  ; fi
if [ "${SGE_TASK_ID}" -eq "18" ]; then ${PATH_EXE}/collieLC_m1s ${PATH_OUT}/CollieLC_En_RHC_E_100_m1s.root  ${PATH_OUT}/CollieIO_En_RHC_E_100.root  ; fi
#
## E cut 1.5 MeV
