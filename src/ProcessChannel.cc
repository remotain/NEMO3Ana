...
namespace ProcessChannel {
	...
	bool ProcessTwoElectronInternal( DataSet *d ){
	    ...
	    Double_t output_min_el_track_r   ; output_tree->Branch("min_el_track_r"   , &output_min_el_track_r   );
	    Double_t output_max_el_track_r   ; output_tree->Branch("max_el_track_r"   , &output_max_el_track_r   );
		...
		// Make all other histos
		histo_collection->Add( new TH1D( TString::Format("%s_h_run"                    , d->GetName()) , "; Run; No.Events",    10000, 1000, 9500                             ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_sectorId"               , d->GetName()) , "; Sector; No.Events",  21, -0.5, 20.5                               ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_sourceId"               , d->GetName()) , "; Source; No.Events",   4, -1.5, 2.5                                ) );
		...
		//
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx"                 , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy"                 , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz"                 , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr"                 , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P1"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P1"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P1"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P1"              , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P2"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P2"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P2"              , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P2"              , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P1_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P1_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P1_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P1_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P2_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P2_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P2_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P2_cold"         , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P1_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P1_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P1_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P1_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P2_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P2_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P2_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P2_warm"         , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P1_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P1_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P1_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P1_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dx_P2_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dy_P2_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dz_P2_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150, -30, 30                                ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_vtx_dr_P2_hot"          , d->GetName()) , "; cm; No.Events / 1mm", 150,   0, 60                                ) );
		...
		//
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt"         , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P1"      , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P1_cold" , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P1_warm" , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P1_hot"  , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P2"      , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P2_cold" , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P2_warm" , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_probInt_P2_hot"  , d->GetName()) , "; Internal Prob.; No.Events", 100, 0, 1. ) );
		...
		//
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength"         , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P1"      , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P1_cold" , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P1_warm" , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P1_hot"  , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P2"      , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P2_cold" , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P2_warm" , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackLength_P2_hot"  , d->GetName()) , "; Min el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength"         , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P1"      , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P1_cold" , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P1_warm" , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P1_hot"  , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P2"      , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P2_cold" , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P2_warm" , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackLength_P2_hot"  , d->GetName()) , "; Max el. - Track Length / cm; No.Events / cm", 100, 0, 500 ) );

		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//
		// MINIMAL/MAXIMAL TRACK CURVATURE
		//
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature"         , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P1"      , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P1_cold" , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P1_warm" , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P1_hot"  , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P2"      , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P2_cold" , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P2_warm" , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_trackCurvature_P2_hot"  , d->GetName()) , "; Min el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );

		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature"         , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P1"      , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P1_cold" , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P1_warm" , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P1_hot"  , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P2"      , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_trackCurvature_P2_cold" , d->GetName()) , "; Max el. - Track Curvature / cm; No.Events / cm", 100, -2000, 2000 ) );
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_In"       , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_In"       , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_In_cold"  , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_In_cold"  , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_In_warm"  , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_In_warm"  , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_Out"      , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_Out"      , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_Out_cold" , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_Out_cold" , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_SS_Out_warm" , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_SS_Out_warm" , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_OS"          , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_OS"          , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_OS_cold"     , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_OS_cold"     , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P1_OS_warm"     , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_min_e_energy_P2_OS_warm"     , d->GetName()) , "; Min E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_In"       , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_In"       , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_In_cold"  , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_In_cold"  , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_In_warm"  , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_In_warm"  , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_Out"      , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_Out"      , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_Out_cold" , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_Out_cold" , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_SS_Out_warm" , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_SS_Out_warm" , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_OS"          , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_OS"          , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_OS_cold"     , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_OS_cold"     , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P1_OS_warm"     , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_max_e_energy_P2_OS_warm"     , d->GetName()) , "; Max E_{e} / MeV; No.Events / 0.1 MeV", 35, 0, 3.5 ) );
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_SS_In_cold"  , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_SS_In_cold"  , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_SS_In_warm"  , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_SS_In_warm"  , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_SS_Out_cold" , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_SS_Out_cold" , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_SS_Out_warm" , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_SS_Out_warm" , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_OS_cold"     , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_OS_cold"     , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P1_OS_warm"     , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_tot_e_energy_P2_OS_warm"     , d->GetName()) , "; #Sigma E_{e} / MeV; No.Events / 0.1 MeV", 46, 0, 4.6 ) );
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//
		// COS THETA
		//
		...
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_In"       , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_In"       , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_In_cold"  , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_In_cold"  , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_In_warm"  , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_In_warm"  , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_Out"      , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_Out"      , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_Out_cold" , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_Out_cold" , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_SS_Out_warm" , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_SS_Out_warm" , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_OS"          , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_OS"          , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_OS_cold"     , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_OS_cold"     , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P1_OS_warm"     , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
		histo_collection->Add( new TH1D( TString::Format("%s_h_cosTheta_P2_OS_warm"     , d->GetName()) , "; Cos(#Theta); No.Events", 25, -1, 1 ) );
	    ...
	    Double_t  el_trkCurvature[2]          ; tree->SetBranchAddress("el_trkCurvature"             , el_trkCurvature              );		
	    ...
	    for (Long64_t iEvt = 0; iEvt < nentries; iEvt++) {
			...
			double el_trkRadius_min    , el_trkRadius_max    ;
			double el_trkCurvature_min , el_trkCurvature_max ;
		    ...
		    if (el_energy_[0] < el_energy_[1]) {
		      ...
		      el_trkSign_min       = el_trkSign[0]      ; el_trkSign_max      = el_trkSign[1]      ;
  		      el_trkRadius_min  = el_trkCurvature[0] ; el_trkRadius_max = el_trkCurvature[1] ;
		      ...
		      el_trkSign_min       = el_trkSign[1]      ; el_trkSign_max      = el_trkSign[0]      ;
  		      el_trkRadius_min  = el_trkCurvature[1] ; el_trkRadius_max = el_trkCurvature[0] ;			  
			...
			el_trkCurvature_min = el_trkRadius_min * el_trkSign_min;
			el_trkCurvature_max = el_trkRadius_max * el_trkSign_max;
			...
			output_min_el_track_r   = el_trkRadius_min ;
			output_max_el_track_r   = el_trkRadius_max ;
		    ...
		    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
		    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
		    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
		    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y())  , weight);
		    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
		    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
		    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
		    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
		    ...
		    if (run < 3396) {
			    ...
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P1"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P1"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P1"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P1"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P1"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P1"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P1"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P1"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
				...
				if( IsHotSpot(el_vtx_z_mean_, vertexSector) ) {
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P1_hot"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P1_hot"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P1_hot"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P1_warm"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P1_warm"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P1_warm"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P1_cold"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P1_cold"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P1_cold"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
		        ...
		        if (el_side_[0] == el_side_[1]) {
					...
					if (el_side_[0] == 0) {
						 ...
						 histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_In" , d->GetName()) ) -> Fill(el_energy_min , weight);
						 histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_In" , d->GetName()) ) -> Fill(el_energy_max , weight);
						 histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_In"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					
						 // SS In Cold/Warm
						 if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
							 histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_SS_In_warm" , d->GetName()) ) -> Fill(tot_e         , weight);
							 histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_In_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
							 histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_In_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
							 histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_In_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						 } else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
							 histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_SS_In_cold" , d->GetName()) ) -> Fill(tot_e         , weight);
							 histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_In_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
							 histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_In_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
							 histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_In_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						 }
					
		          	} else { 
					  
		            	histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_SS_Out" , d->GetName()) ) -> Fill(tot_e         , weight);
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_Out" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_Out" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_Out"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					
						// SS Out Cold/Warm
						if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
							histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_SS_Out_warm" , d->GetName()) ) -> Fill(tot_e         , weight);						
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_Out_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_Out_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_Out_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
					    	histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_SS_Out_cold" , d->GetName()) ) -> Fill(tot_e         , weight);
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_SS_Out_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_SS_Out_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P1_SS_Out_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						}
					...
					histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_OS" , d->GetName()) ) -> Fill(el_energy_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_OS" , d->GetName()) ) -> Fill(el_energy_max , weight);
					histo_collection->Find(TString::Format("%s_h_cosTheta_P1_OS"     , d->GetName()) ) -> Fill(cosTheta      , weight);

					// OS Cold/Warm
					if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
						histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_OS_warm" , d->GetName()) ) -> Fill(tot_e         , weight);
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_OS_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_OS_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P1_OS_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
					    histo_collection->Find(TString::Format("%s_h_tot_e_energy_P1_OS_cold" , d->GetName()) ) -> Fill(tot_e         , weight);						
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P1_OS_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P1_OS_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P1_OS_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
		            }
			...
			// End P1 Start P2
   			    ...
   			    histo_collection->Find(TString::Format("%s_h_probInt_P2"           , d->GetName()) ) -> Fill(probInt          , weight);
				histo_collection->Find(TString::Format("%s_h_min_e_trackLength_P2" , d->GetName()) ) -> Fill(el_track_len_min , weight);
				histo_collection->Find(TString::Format("%s_h_max_e_trackLength_P2" , d->GetName()) ) -> Fill(el_track_len_max , weight);
				histo_collection->Find(TString::Format("%s_h_min_e_trackCurvature_P2" , d->GetName()) ) -> Fill(el_trkCurvature_min , weight);
				histo_collection->Find(TString::Format("%s_h_max_e_trackCurvature_P2" , d->GetName()) ) -> Fill(el_trkCurvature_max , weight);			
			    ...
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P2"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P2"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P2"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
			    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P2"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P2"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P2"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P2"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
			    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P2"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);


				// P2 Hot/Cold/Warm
				if( IsHotSpot(el_vtx_z_mean_, vertexSector) ) {
					
	   			    histo_collection->Find(TString::Format("%s_h_probInt_P2_hot"           , d->GetName()) ) -> Fill(probInt          , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackLength_P2_hot" , d->GetName()) ) -> Fill(el_track_len_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackLength_P2_hot" , d->GetName()) ) -> Fill(el_track_len_max , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackCurvature_P2_hot" , d->GetName()) ) -> Fill(el_trkCurvature_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackCurvature_P2_hot" , d->GetName()) ) -> Fill(el_trkCurvature_max , weight);			
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P2_hot"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P2_hot"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P2_hot"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);


				} else if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
					
	   			    histo_collection->Find(TString::Format("%s_h_probInt_P2_warm"           , d->GetName()) ) -> Fill(probInt          , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackLength_P2_warm" , d->GetName()) ) -> Fill(el_track_len_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackLength_P2_warm" , d->GetName()) ) -> Fill(el_track_len_max , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackCurvature_P2_warm" , d->GetName()) ) -> Fill(el_trkCurvature_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackCurvature_P2_warm" , d->GetName()) ) -> Fill(el_trkCurvature_max , weight);			
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P2_warm"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P2_warm"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P2_warm"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y())  , weight);
					
					
				} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
					
	   			    histo_collection->Find(TString::Format("%s_h_probInt_P2_cold"           , d->GetName()) ) -> Fill(probInt          , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackLength_P2_cold" , d->GetName()) ) -> Fill(el_track_len_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackLength_P2_cold" , d->GetName()) ) -> Fill(el_track_len_max , weight);
					histo_collection->Find(TString::Format("%s_h_min_e_trackCurvature_P2_cold" , d->GetName()) ) -> Fill(el_trkCurvature_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_trackCurvature_P2_cold" , d->GetName()) ) -> Fill(el_trkCurvature_max , weight);			
				    ...
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_x_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_min.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_y_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_min.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_z_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_min.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_min_e_vtx_r_P2_cold"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_min.x()*el_vtx_min.x() + el_vtx_min.y()*el_vtx_min.y()) , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_x_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_max.x()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_y_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_max.y()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_z_P2_cold"       , d->GetName()) ) -> Fill(el_vtx_max.z()    , weight);
				    histo_collection->Find(TString::Format("%s_h_max_e_vtx_r_P2_cold"       , d->GetName()) ) -> Fill(TMath::Sqrt(el_vtx_max.x()*el_vtx_max.x() + el_vtx_max.y()*el_vtx_max.y()) , weight);
		        ...
		        if (el_side_[0] == el_side_[1]) {
					...
					if (el_side_[0] == 0) {
						...
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_In" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_In" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_In"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					
						// SS In Cold/Warm
						if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_In_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_In_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_In_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
							histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_SS_In_warm" , d->GetName()) ) -> Fill(tot_e         , weight);
						} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_In_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_In_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_In_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					    	histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_SS_In_cold" , d->GetName()) ) -> Fill(tot_e         , weight);
						}
					
					} else {
					  
						histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_SS_Out" , d->GetName()) ) -> Fill(tot_e         , weight);
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_Out" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_Out" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_Out"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					
						// SS Out Cold/Warm
						if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_Out_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_Out_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_Out_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
							histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_SS_Out_warm" , d->GetName()) ) -> Fill(tot_e         , weight);
						} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
							histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_SS_Out_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
							histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_SS_Out_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
							histo_collection->Find(TString::Format("%s_h_cosTheta_P2_SS_Out_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						    histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_SS_Out_cold" , d->GetName()) ) -> Fill(tot_e         , weight);
			          	}
				 	}
					...
					histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_OS" , d->GetName()) ) -> Fill(el_energy_min , weight);
					histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_OS" , d->GetName()) ) -> Fill(el_energy_max , weight);
					histo_collection->Find(TString::Format("%s_h_cosTheta_P2_OS"     , d->GetName()) ) -> Fill(cosTheta      , weight);
	
					// OS Cold/Warm
					if( IsWarmSpot(el_vtx_z_mean_, vertexSector) ) {
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_OS_warm" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_OS_warm" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P2_OS_warm"     , d->GetName()) ) -> Fill(cosTheta      , weight);
						histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_OS_warm" , d->GetName()) ) -> Fill(tot_e         , weight);
					} else if( IsColdSpot(el_vtx_z_mean_, vertexSector) ) {
						histo_collection->Find(TString::Format("%s_h_min_e_energy_P2_OS_cold" , d->GetName()) ) -> Fill(el_energy_min , weight);
						histo_collection->Find(TString::Format("%s_h_max_e_energy_P2_OS_cold" , d->GetName()) ) -> Fill(el_energy_max , weight);
						histo_collection->Find(TString::Format("%s_h_cosTheta_P2_OS_cold"     , d->GetName()) ) -> Fill(cosTheta      , weight);
					    histo_collection->Find(TString::Format("%s_h_tot_e_energy_P2_OS_cold" , d->GetName()) ) -> Fill(tot_e         , weight);
			        }
	...
	bool ProcessOneElectronOneGammaInternal( DataSet *d ){
		...
		histo_collection -> Add( new TH1D ( TString::Format("%s_h_g_energy"       , d->GetName()) , "; E_{#gamma}; No. Events / 0.1 MeV"         ,  60, 0, 6  ) );
	    ...
	    for (Long64_t iEvt = 0; iEvt < nentries; iEvt++) {
			...
			histo_collection->Find(TString::Format("%s_h_tot_energy" , d->GetName()) ) -> Fill(el_energy_ + gmc_energy_[0], weight);
			histo_collection->Find(TString::Format("%s_h_e_energy"   , d->GetName()) ) -> Fill(el_energy_, weight);
			histo_collection->Find(TString::Format("%s_h_g_energy"   , d->GetName()) ) -> Fill(gmc_energy_[0], weight);
