{
	...
	TFile * f = new TFile("/Users/alberto/Software/SuperNEMO/work/nemo3/plot/plot_20150217/OneElectronOneGammaInt.root");
	TDirectory * fdir = 0;
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "cInt"   , "cInt"   ,  0 , 1.00000e+00 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "cTl208" , "cTl208" ,  1 , 1.00000e+00 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "cBi210" , "cBi210" ,  2 , 2.71376e+00 , 0.001 ) ); 
	DataManagement::AddParameter( new Parameter( "cBi214" , "cBi214" ,  3 , 9.99981e-01 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "cRnP1"  , "cRnP1"  ,  4 , 9.99537e-01 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "cRnP2"  , "cRnP2"  ,  5 , 9.99946e-01 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "cExt"   , "cExt"   ,  6 , 1.12675e+00 , 0.001 ) );

	//DataManagement::AddParameter( new Parameter( "cInt"   , "cInt"   ,  0 , 1. , 0.001 ) ); DataManagement::FindParameter( "cInt"   ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cTl208" , "cTl208" ,  1 , 1. , 0.001 ) ); DataManagement::FindParameter( "cTl208" ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cBi210" , "cBi210" ,  2 , 1. , 0.001 ) ); DataManagement::FindParameter( "cBi210" ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cBi214" , "cBi214" ,  3 , 1. , 0.001 ) ); DataManagement::FindParameter( "cBi214" ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cRnP1"  , "cRnP1"  ,  4 , 1. , 0.001 ) ); DataManagement::FindParameter( "cRnP1"  ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cRnP2"  , "cRnP2"  ,  5 , 1. , 0.001 ) ); DataManagement::FindParameter( "cRnP2"  ) -> SetFix(); 
	//DataManagement::AddParameter( new Parameter( "cExt"   , "cExt"   ,  6 , 1. , 0.001 ) ); DataManagement::FindParameter( "cExt"   ) -> SetFix();
	...
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "Cd116_Tl208"  , "^{208}Tl Cd116"  , DataManagement::FindDataSet( "Cd116_Tl208"    ) , DataManagement::FindParameter( "cTl208" ) , 0.440*0.18*1e-3 , 0.440*0.02*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Tl208"  )->SetFillColor( kOrange + 0 );	
	DataManagement::AddComponent( new Component( "Cd116_Ac228"  , "^{228}Ac Cd116"  , DataManagement::FindDataSet( "Cd116_Ac228"    ) , DataManagement::FindParameter( "cTl208" ) , 0.440*0.18*1e-3 , 0.440*0.02*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Ac228"  )->SetFillColor( kOrange + 1 );	
	DataManagement::AddComponent( new Component( "Cd116_Pb211"  , "^{211}Pb Cd116"  , DataManagement::FindDataSet( "Cd116_Pb211"    ) , DataManagement::FindParameter( "cTl208" ) , 0.440*0.18*1e-3 , 0.440*0.02*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Pb211"  )->SetFillColor( kOrange + 3 );	
	DataManagement::AddComponent( new Component( "Cd116_Bi214"  , "^{214}Bi Cd116"  , DataManagement::FindDataSet( "Cd116_Bi214"    ) , DataManagement::FindParameter( "cBi214" ) , 0.440*0.30*1e-3 , 0.440*0.08*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Bi214"  )->SetFillColor( kGreen +  0 );
	DataManagement::AddComponent( new Component( "Cd116_Pb214"  , "^{214}Pb Cd116"  , DataManagement::FindDataSet( "Cd116_pb214_VT" ) , DataManagement::FindParameter( "cBi214" ) , 0.440*0.30*1e-3 , 0.440*0.08*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Pb214"  )->SetFillColor( kGreen +  1 );
	...
	DataManagement::AddComponent( new Component( "Cd116_K40"    , "^{40}K Cd116"    , DataManagement::FindDataSet( "Cd116_K40"      ) , DataManagement::FindParameter( "cInt" ) ,       10.3*1e-3 ,       0.10*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_K40"    )->SetFillColor( kViolet + 1 );	
	DataManagement::AddComponent( new Component( "Cd116_Pa234m" , "^{234m}Pa Cd116" , DataManagement::FindDataSet( "Cd116_Pa234m"   ) , DataManagement::FindParameter( "cInt" ) ,       1.89*1e-3 ,       0.04*1e-3 , true , 1 )); DataManagement::FindComponent("Cd116_Pa234m" )->SetFillColor( kViolet + 2 );	
	//////////////////////////////////////////////////////////////////////////////
	//	
	// Bi-210
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "SFoil_Bi210" , "^{210}Bi SFoil" , DataManagement::FindDataSet( "SFoil_Bi210" ) , DataManagement::FindParameter( "cBi210") ,   0.95 ,  0.05 , true , 1 )); DataManagement::FindComponent("SFoil_Bi210") -> SetFillColor( kGreen + 2 );	
	DataManagement::AddComponent( new Component( "SWire_Bi210" , "^{210}Bi SWire" , DataManagement::FindDataSet( "SWire_Bi210" ) , DataManagement::FindParameter( "cBi210") ,   10.7 ,  0.5 , true , 1 )); DataManagement::FindComponent("SWire_Bi210") -> SetFillColor( kGreen + 1 );	
	DataManagement::AddComponent( new Component( "SScin_Bi210" , "^{210}Bi SScin" , DataManagement::FindDataSet( "SScin_Bi210" ) , DataManagement::FindParameter( "cBi210") ,  812.0 , 15.0 , true , 1 )); DataManagement::FindComponent("SScin_Bi210") -> SetFillColor( kGreen + 0 );		
	//////////////////////////////////////////////////////////////////////////////
	//	
	// Rn in tracker chamber
	//
	//////////////////////////////////////////////////////////////////////////////		
	DataManagement::AddComponent( new Component( "SWire_Bi214_P1_IN"  , "^{214}Bi SWire P1 In " , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 6.62169e-01 , 9.7e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Bi214_P1_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SWire_Bi214_P1_OUT" , "^{214}Bi SWire P1 Out" , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 6.53893e-01 , 8.6e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Bi214_P1_OUT" )->SetFillColor( kAzure +  2 );
	DataManagement::AddComponent( new Component( "SWire_Pb214_P1_IN"  , "^{214}Pb SWire P1 In " , DataManagement::FindDataSet( "SWire_Pb214" ) , DataManagement::FindParameter( "cRnP1" ) , 6.62169e-01 , 9.7e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Pb214_P1_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SWire_Pb214_P1_OUT" , "^{214}Pb SWire P1 Out" , DataManagement::FindDataSet( "SWire_Pb214" ) , DataManagement::FindParameter( "cRnP1" ) , 6.53893e-01 , 8.6e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Pb214_P1_OUT" )->SetFillColor( kAzure +  2 );

	DataManagement::AddComponent( new Component( "SFoil_Bi214_P1_IN"  , "^{214}Bi SFoil P1 In " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.22140e-02 , 3.01516e-03 , true , 1 )); DataManagement::FindComponent( "SFoil_Bi214_P1_IN"  )->SetFillColor( kAzure +  3 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P1_OUT" , "^{214}Bi SFoil P1 Out" , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.69628e-02 , 2.58033e-03 , true , 1 )); DataManagement::FindComponent( "SFoil_Bi214_P1_OUT" )->SetFillColor( kAzure +  4 );
	DataManagement::AddComponent( new Component( "SFoil_Pb214_P1_IN"  , "^{214}Pb SFoil P1 In " , DataManagement::FindDataSet( "SFoil_Pb214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.22140e-02 , 3.01516e-03 , true , 1 )); DataManagement::FindComponent( "SFoil_Pb214_P1_IN"  )->SetFillColor( kAzure +  3 );
	DataManagement::AddComponent( new Component( "SFoil_Pb214_P1_OUT" , "^{214}Pb SFoil P1 Out" , DataManagement::FindDataSet( "SFoil_Pb214" ) , DataManagement::FindParameter( "cRnP1" ) , 1.69628e-02 , 2.58033e-03 , true , 1 )); DataManagement::FindComponent( "SFoil_Pb214_P1_OUT" )->SetFillColor( kAzure +  4 );

	DataManagement::AddComponent( new Component( "SWire_Bi214_P2_IN"  , "^{214}Bi SWire P2 In " , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 8.53192e-02 , 2.7e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Bi214_P2_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SWire_Bi214_P2_OUT" , "^{214}Bi SWire P2 Out" , DataManagement::FindDataSet( "SWire_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.00534e-01 , 2.2e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Bi214_P2_OUT" )->SetFillColor( kAzure +  2 );
	DataManagement::AddComponent( new Component( "SWire_Pb214_P2_IN"  , "^{214}Pb SWire P2 In " , DataManagement::FindDataSet( "SWire_Pb214" ) , DataManagement::FindParameter( "cRnP2" ) , 8.53192e-02 , 2.7e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Pb214_P2_IN"  )->SetFillColor( kAzure +  1 );
	DataManagement::AddComponent( new Component( "SWire_Pb214_P2_OUT" , "^{214}Pb SWire P2 Out" , DataManagement::FindDataSet( "SWire_Pb214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.00534e-01 , 2.2e-03     , true , 1 )); DataManagement::FindComponent( "SWire_Pb214_P2_OUT" )->SetFillColor( kAzure +  2 );

	DataManagement::AddComponent( new Component( "SFoil_Bi214_P2_IN"  , "^{214}Bi SFoil P2 In " , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.14207e-03 , 3.52491e-04 , true , 1 )); DataManagement::FindComponent( "SFoil_Bi214_P2_IN"  )->SetFillColor( kAzure +  3 );
	DataManagement::AddComponent( new Component( "SFoil_Bi214_P2_OUT" , "^{214}Bi SFoil P2 Out" , DataManagement::FindDataSet( "SFoil_Bi214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.07416e-03 , 3.27150e-04 , true , 1 )); DataManagement::FindComponent( "SFoil_Bi214_P2_OUT" )->SetFillColor( kAzure +  4 );	
	DataManagement::AddComponent( new Component( "SFoil_Pb214_P2_IN"  , "^{214}Pb SFoil P2 In " , DataManagement::FindDataSet( "SFoil_Pb214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.14207e-03 , 3.52491e-04 , true , 1 )); DataManagement::FindComponent( "SFoil_Pb214_P2_IN"  )->SetFillColor( kAzure +  3 );
	DataManagement::AddComponent( new Component( "SFoil_Pb214_P2_OUT" , "^{214}Pb SFoil P2 Out" , DataManagement::FindDataSet( "SFoil_Pb214" ) , DataManagement::FindParameter( "cRnP2" ) , 1.07416e-03 , 3.27150e-04 , true , 1 )); DataManagement::FindComponent( "SFoil_Pb214_P2_OUT" )->SetFillColor( kAzure +  4 );	
	...
	//
	//////////////////////////////////////////////////////////////////////////////		
	tot_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_tot_energy_P1" ));         
	...
	tot_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_K40"          ) , hcoll->Find( "Cd116_K40_h_tot_energy_P1"      ));
	tot_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m"       ) , hcoll->Find( "Cd116_Pa234m_h_tot_energy_P1"   ));
	tot_energy_P1 -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210"        ) , hcoll->Find( "SFoil_Bi210_h_tot_energy_P1"    ));      
	tot_energy_P1 -> AddComponent( DataManagement::FindComponent( "SWire_Bi210"        ) , hcoll->Find( "SWire_Bi210_h_tot_energy_P1"    ));      
	...
	e_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_e_energy_P1" ));         
	...
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_g_energy_P1" ));         
	...
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_Pb211"        ) , hcoll->Find( "Cd116_Pb211_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"        ) , hcoll->Find( "Cd116_Bi214_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"        ) , hcoll->Find( "Cd116_pb214_VT_h_g_energy_P1" ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"        ) , hcoll->Find( "Mylar_Bi214_h_g_energy_P1"    )); 
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"        ) , hcoll->Find( "Mylar_Pb214_h_g_energy_P1"    )); 
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_K40"          ) , hcoll->Find( "Cd116_K40_h_g_energy_P1"      ));
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m"       ) , hcoll->Find( "Cd116_Pa234m_h_g_energy_P1"   ));
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210"        ) , hcoll->Find( "SFoil_Bi210_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SWire_Bi210"        ) , hcoll->Find( "SWire_Bi210_h_g_energy_P1"    ));      
	...
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1_IN"  ) , hcoll->Find( "SWire_Pb214_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1_OUT" ) , hcoll->Find( "SWire_Pb214_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1_IN"  ) , hcoll->Find( "SFoil_Pb214_h_g_energy_P1"    ));      
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1_OUT" ) , hcoll->Find( "SFoil_Pb214_h_g_energy_P1"    ));      
	...
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"       ) , hcoll->Find( "ScintInn_K40_h_g_energy_P1"   ));         
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"       ) , hcoll->Find( "ScintOut_K40_h_g_energy_P1"   ));         
	g_energy_P1 -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"       ) , hcoll->Find( "ScintPet_K40_h_g_energy_P1"   ));         

	tot_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_tot_energy_P2" ));         
	...
	tot_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_K40"          ) , hcoll->Find( "Cd116_K40_h_tot_energy_P2"      ));
	tot_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m"       ) , hcoll->Find( "Cd116_Pa234m_h_tot_energy_P2"   ));      
	tot_energy_P2 -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210"        ) , hcoll->Find( "SFoil_Bi210_h_tot_energy_P2"    ));      
	tot_energy_P2 -> AddComponent( DataManagement::FindComponent( "SWire_Bi210"        ) , hcoll->Find( "SWire_Bi210_h_tot_energy_P2"    ));      
	...
	e_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_e_energy_P2" ));         
	...
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll->Find( "Cd116_2b2n_m14_h_g_energy_P2" ));         
	...
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_Pb211"        ) , hcoll->Find( "Cd116_Pb211_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"        ) , hcoll->Find( "Cd116_Bi214_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"        ) , hcoll->Find( "Cd116_pb214_VT_h_g_energy_P2" ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"        ) , hcoll->Find( "Mylar_Bi214_h_g_energy_P2"    ));
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"        ) , hcoll->Find( "Mylar_Pb214_h_g_energy_P2"    ));
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_K40"          ) , hcoll->Find( "Cd116_K40_h_g_energy_P2"      ));
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m"       ) , hcoll->Find( "Cd116_Pa234m_h_g_energy_P2"   ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210"        ) , hcoll->Find( "SFoil_Bi210_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SWire_Bi210"        ) , hcoll->Find( "SWire_Bi210_h_g_energy_P2"    ));      
	...
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2_IN"  ) , hcoll->Find( "SWire_Pb214_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2_OUT" ) , hcoll->Find( "SWire_Pb214_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2_IN"  ) , hcoll->Find( "SFoil_Pb214_h_g_energy_P2"    ));      
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2_OUT" ) , hcoll->Find( "SFoil_Pb214_h_g_energy_P2"    ));      
	...
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"       ) , hcoll->Find( "ScintInn_K40_h_g_energy_P2"   ));         
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"       ) , hcoll->Find( "ScintOut_K40_h_g_energy_P2"   ));         
	g_energy_P2 -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"       ) , hcoll->Find( "ScintPet_K40_h_g_energy_P2"   ));         

	tot_energy_3g -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"     ) , hcoll_3g->Find( "Cd116_2b2n_m14_h_tot_energy" ));         
	...
	tot_energy_3g -> AddComponent( DataManagement::FindComponent( "Cd116_K40"          ) , hcoll_3g->Find( "Cd116_K40_h_tot_energy"      ));
	tot_energy_3g -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m"       ) , hcoll_3g->Find( "Cd116_Pa234m_h_tot_energy"   ));      
	tot_energy_3g -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210"        ) , hcoll_3g->Find( "SFoil_Bi210_h_tot_energy"    ));      
	tot_energy_3g -> AddComponent( DataManagement::FindComponent( "SWire_Bi210"        ) , hcoll_3g->Find( "SWire_Bi210_h_tot_energy"    ));      
	...
	g_energy_P1   -> SetLogScale(kTRUE); g_energy_P1   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,"_log.eps");
	...
	g_energy_P2   -> SetLogScale(kTRUE); g_energy_P2   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,"_log.eps");
