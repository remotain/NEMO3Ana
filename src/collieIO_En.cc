...
int main(int argc, char* argv[]) {
    ...
    /*  0 */ double Cd116_Tl208_weight    = 5.93241           ; TH1D *  Cd116_Tl208     = 0; int Cd116_Tl208_i    ; if( Cd116_Tl208_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Tl208"    ); fdir->cd(); Cd116_Tl208      = (TH1D *) fdir->Get("Cd116_Tl208_h_tot_e_energy"    ) -> Clone( "Cd116_Tl208"    ) ; Cd116_Tl208    -> Sumw2() ; Cd116_Tl208    -> Scale( Cd116_Tl208_weight    / Cd116_Tl208     ->Integral() ) ; bkgdNames.push_back("Cd116_Tl208"   ); vbkgd.push_back( Cd116_Tl208    ); Cd116_Tl208_i    = index+1; };
    ...
    /*  2 */ double Cd116_Bi212_weight    = 2.74493           ; TH1D *  Cd116_Bi212     = 0; int Cd116_Bi212_i    ; if( Cd116_Bi212_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Bi212"    ); fdir->cd(); Cd116_Bi212      = (TH1D *) fdir->Get("Cd116_Bi212_h_tot_e_energy"    ) -> Clone( "Cd116_Bi212"    ) ; Cd116_Bi212    -> Sumw2() ; Cd116_Bi212    -> Scale( Cd116_Bi212_weight    / Cd116_Bi212     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi212"   ); vbkgd.push_back( Cd116_Bi212    ); Cd116_Bi212_i    = index+1; };
    /*  3 */ double Cd116_Bi214_weight    = 18.2853           ; TH1D *  Cd116_Bi214     = 0; int Cd116_Bi214_i    ; if( Cd116_Bi214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Bi214"    ); fdir->cd(); Cd116_Bi214      = (TH1D *) fdir->Get("Cd116_Bi214_h_tot_e_energy"    ) -> Clone( "Cd116_Bi214"    ) ; Cd116_Bi214    -> Sumw2() ; Cd116_Bi214    -> Scale( Cd116_Bi214_weight    / Cd116_Bi214     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi214"   ); vbkgd.push_back( Cd116_Bi214    ); Cd116_Bi214_i    = index+1; };
    /*  4 */ double Cd116_Pb214_weight    = 0.186478          ; TH1D *  Cd116_Pb214     = 0; int Cd116_Pb214_i    ; if( Cd116_Pb214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Pb214_VT" ); fdir->cd(); Cd116_Pb214      = (TH1D *) fdir->Get("Cd116_Pb214_VT_h_tot_e_energy" ) -> Clone( "Cd116_Pb214"    ) ; Cd116_Pb214    -> Sumw2() ; Cd116_Pb214    -> Scale( Cd116_Pb214_weight    / Cd116_Pb214     ->Integral() ) ; bkgdNames.push_back("Cd116_Pb214"   ); vbkgd.push_back( Cd116_Pb214    ); Cd116_Pb214_i    = index+1; };
    ...
    /* 11 */ double SScin_Bi210_weight    = 1.756             ; TH1D *  SScin_Bi210     = 0; int SScin_Bi210_i    ; if( SScin_Bi210_weight    != 0 ) { fdir = (TDirectory *) infile->Get("SScin_Bi210"    ); fdir->cd(); SScin_Bi210      = (TH1D *) fdir->Get("SScin_Bi210_h_tot_e_energy"    ) -> Clone( "SScin_Bi210"    ) ; SScin_Bi210    -> Sumw2() ; SScin_Bi210    -> Scale( SScin_Bi210_weight    / SScin_Bi210     ->Integral() ) ; bkgdNames.push_back("SScin_Bi210"   ); vbkgd.push_back( SScin_Bi210    ); SScin_Bi210_i    = index+1; };
    ...
    /* 22 */ double CuTower_Co60_weight   = 3.77603           ; TH1D *  CuTower_Co60    = 0; int CuTower_Co60_i   ; if( CuTower_Co60_weight   != 0 ) { fdir = (TDirectory *) infile->Get("CuTower_Co60"   ); fdir->cd(); CuTower_Co60     = (TH1D *) fdir->Get("CuTower_Co60_h_tot_e_energy"   ) -> Clone( "CuTower_Co60"   ) ; CuTower_Co60   -> Sumw2() ; CuTower_Co60   -> Scale( CuTower_Co60_weight   / CuTower_Co60    ->Integral() ) ; bkgdNames.push_back("CuTower_Co60"  ); vbkgd.push_back( CuTower_Co60   ); CuTower_Co60_i   = index+1; };
    /* 23 */ double Air_Bi214_P1_weight   = 4.19271           ; TH1D *  Air_Bi214_P1    = 0; int Air_Bi214_P1_i   ; if( Air_Bi214_P1_weight   != 0 ) { fdir = (TDirectory *) infile->Get("Air_Bi214"      ); fdir->cd(); Air_Bi214_P1     = (TH1D *) fdir->Get("Air_Bi214_h_tot_e_energy"      ) -> Clone( "Air_Bi214_P1"   ) ; Air_Bi214_P1   -> Sumw2() ; Air_Bi214_P1   -> Scale( Air_Bi214_P1_weight   / Air_Bi214_P1    ->Integral() ) ; bkgdNames.push_back("Air_Bi214_P1"  ); vbkgd.push_back( Air_Bi214_P1   ); Air_Bi214_P1_i   = index+1; };
    ...
    /* 25 */ double PMT_Bi214_weight      = 30.7385           ; TH1D *  PMT_Bi214       = 0; int PMT_Bi214_i      ; if( PMT_Bi214_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Bi214"      ); fdir->cd(); PMT_Bi214        = (TH1D *) fdir->Get("PMT_Bi214_h_tot_e_energy"      ) -> Clone( "PMT_Bi214"      ) ; PMT_Bi214      -> Sumw2() ; PMT_Bi214      -> Scale( PMT_Bi214_weight      / PMT_Bi214       ->Integral() ) ; bkgdNames.push_back("PMT_Bi214"     ); vbkgd.push_back( PMT_Bi214      ); PMT_Bi214_i      = index+1; };
    /* 26 */ double PMT_Tl208_weight      = 23.2701           ; TH1D *  PMT_Tl208       = 0; int PMT_Tl208_i      ; if( PMT_Tl208_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Tl208"      ); fdir->cd(); PMT_Tl208        = (TH1D *) fdir->Get("PMT_Tl208_h_tot_e_energy"      ) -> Clone( "PMT_Tl208"      ) ; PMT_Tl208      -> Sumw2() ; PMT_Tl208      -> Scale( PMT_Tl208_weight      / PMT_Tl208       ->Integral() ) ; bkgdNames.push_back("PMT_Tl208"     ); vbkgd.push_back( PMT_Tl208      ); PMT_Tl208_i      = index+1; };
    /* 27 */ double PMT_Ac228_weight      = 3.60944           ; TH1D *  PMT_Ac228       = 0; int PMT_Ac228_i      ; if( PMT_Ac228_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Ac228"      ); fdir->cd(); PMT_Ac228        = (TH1D *) fdir->Get("PMT_Ac228_h_tot_e_energy"      ) -> Clone( "PMT_Ac228"      ) ; PMT_Ac228      -> Sumw2() ; PMT_Ac228      -> Scale( PMT_Ac228_weight      / PMT_Ac228       ->Integral() ) ; bkgdNames.push_back("PMT_Ac228"     ); vbkgd.push_back( PMT_Ac228      ); PMT_Ac228_i      = index+1; };
    /* 28 */ double PMT_K40_weight        = 16.7905           ; TH1D *  PMT_K40         = 0; int PMT_K40_i        ; if( PMT_K40_weight        != 0 ) { fdir = (TDirectory *) infile->Get("PMT_K40"        ); fdir->cd(); PMT_K40          = (TH1D *) fdir->Get("PMT_K40_h_tot_e_energy"        ) -> Clone( "PMT_K40"        ) ; PMT_K40        -> Sumw2() ; PMT_K40        -> Scale( PMT_K40_weight        / PMT_K40         ->Integral() ) ; bkgdNames.push_back("PMT_K40"       ); vbkgd.push_back( PMT_K40        ); PMT_K40_i        = index+1; };
