{
	...
	TFile * f = new TFile("/Users/alberto/Software/SuperNEMO/work/nemo3/plot/plot_20141213/OneElectronOneAlphaHistos.root");
	TDirectory * fdir = 0;
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "Mylar_Bi214"        , "Mylar_Bi214"        , 0 , 0.0033 , 0.001 ) );
	DataManagement::AddParameter( new Parameter( "Cd116_Bi214"        , "Cd116_Bi214"        , 1 , 0.0002 , 0.001 ) );
	...
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P1_IN_IN"   , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P1_IN_IN"   )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P1_OUT_OUT" , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P1_OUT_OUT" )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P1_IN_OUT"  , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P1_IN_OUT"  )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P1_OUT_IN"  , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P1_OUT_IN"  )->SetFillColor( kGreen  +  1 );
	...
	//
	//////////////////////////////////////////////////////////////////////////////
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P2_IN_IN"   , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P2_IN_IN"   )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P2_OUT_OUT" , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P2_OUT_OUT" )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P2_IN_OUT"  , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P2_IN_OUT"  )->SetFillColor( kGreen  +  1 );
	DataManagement::AddComponent( new Component( "Mylar_Bi214_P2_OUT_IN"  , "^{214}Bi Mylar        " , DataManagement::FindDataSet( "Mylar_Bi214" ) , DataManagement::FindParameter( "Mylar_Bi214"        ) , 1.0 )); DataManagement::FindComponent( "Mylar_Bi214_P2_OUT_IN"  )->SetFillColor( kGreen  +  1 );
