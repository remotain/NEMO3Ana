...
{   
   ...
   TString fdir = "/sps/nemo/scratch/remoto/nemo3/plot/plot_UPDATE_TECHNOTE_20160429/";
   ...
   Cd116_Tl208_weight       = 6.52838           ; if ( Cd116_Tl208_weight    != 0 ) { samples.push_back( "Cd116_Tl208"    ); };      
   Cd116_Ac228_weight       = 7.62351           ; if ( Cd116_Ac228_weight    != 0 ) { samples.push_back( "Cd116_Ac228"    ); };      
   Cd116_Bi212_weight       = 3.00708           ; if ( Cd116_Bi212_weight    != 0 ) { samples.push_back( "Cd116_Bi212"    ); };      
   Cd116_Bi214_weight       = 18.1504           ; if ( Cd116_Bi214_weight    != 0 ) { samples.push_back( "Cd116_Bi214"    ); };      
   Cd116_Pb214_weight       = 0.186417          ; if ( Cd116_Pb214_weight    != 0 ) { samples.push_back( "Cd116_Pb214_VT" ); };         
   Mylar_Bi214_weight       = 11.1346           ; if ( Mylar_Bi214_weight    != 0 ) { samples.push_back( "Mylar_Bi214"    ); };      
   Mylar_Pb214_weight       = 0.496238          ; if ( Mylar_Pb214_weight    != 0 ) { samples.push_back( "Mylar_Pb214"    ); };      
   Cd116_K40_weight         = 8.9841+25.8272    ; if ( Cd116_K40_weight      != 0 ) { samples.push_back( "Cd116_K40"      ); };    
   Cd116_Pa234m_weight      = 27.9307+72.4667   ; if ( Cd116_Pa234m_weight   != 0 ) { samples.push_back( "Cd116_Pa234m"   ); };       
   SFoil_Bi210_weight       = 0+23.2438         ; if ( SFoil_Bi210_weight    != 0 ) { samples.push_back( "SFoil_Bi210"    ); };      
   SWire_Bi210_weight       = 0.136147+0.624187 ; if ( SWire_Bi210_weight    != 0 ) { samples.push_back( "SWire_Bi210"    ); };      
   SScin_Bi210_weight       = 1.75641           ; if ( SScin_Bi210_weight    != 0 ) { samples.push_back( "SScin_Bi210"    ); };      
   SScin_Bi214_weight       = 0.0510754         ; if ( SScin_Bi214_weight    != 0 ) { samples.push_back( "SScin_Bi214"    ); };      
   SScin_Pb214_weight       = 0                 ; if ( SScin_Pb214_weight    != 0 ) { samples.push_back( "SScin_Pb214"    ); };      
   SWire_Tl208_weight       = 0.217623+1.07641  ; if ( SWire_Tl208_weight    != 0 ) { samples.push_back( "SWire_Tl208"    ); };      
   SWire_Bi214_weight       = 21.4188+17.8236   ; if ( SWire_Bi214_weight    != 0 ) { samples.push_back( "SWire_Bi214"    ); };      
   SFoil_Bi214_weight       = 5.83533+2.80427   ; if ( SFoil_Bi214_weight    != 0 ) { samples.push_back( "SFoil_Bi214"    ); };      
   SWire_Pb214_weight       = 0.458486+0.649167 ; if ( SWire_Pb214_weight    != 0 ) { samples.push_back( "SWire_Pb214"    ); };      
   SFoil_Pb214_weight       = 0.218761+0.195287 ; if ( SFoil_Pb214_weight    != 0 ) { samples.push_back( "SFoil_Pb214"    ); };      
   FeShield_Bi214_weight    = 50.7021           ; if ( FeShield_Bi214_weight != 0 ) { samples.push_back( "FeShield_Bi214" ); };         
   FeShield_Tl208_weight    = 0.859465          ; if ( FeShield_Tl208_weight != 0 ) { samples.push_back( "FeShield_Tl208" ); };         
   FeShield_Ac228_weight    = 0.126868          ; if ( FeShield_Ac228_weight != 0 ) { samples.push_back( "FeShield_Ac228" ); };         
   CuTower_Co60_weight      = 3.9407            ; if ( CuTower_Co60_weight   != 0 ) { samples.push_back( "CuTower_Co60"   ); };       
   Air_Bi214_P1_weight      = 4.19744           ; if ( Air_Bi214_P1_weight   != 0 ) { samples.push_back( "Air_Bi214"      ); };    
   Air_Tl208_P1_weight      = 0                 ; if ( Air_Tl208_P1_weight   != 0 ) { samples.push_back( "Air_Tl208"      ); };    
   PMT_Bi214_weight         = 27.9661           ; if ( PMT_Bi214_weight      != 0 ) { samples.push_back( "PMT_Bi214"      ); };    
   PMT_Tl208_weight         = 22.923            ; if ( PMT_Tl208_weight      != 0 ) { samples.push_back( "PMT_Tl208"      ); };    
   PMT_Ac228_weight         = 3.60712           ; if ( PMT_Ac228_weight      != 0 ) { samples.push_back( "PMT_Ac228"      ); };    
   PMT_K40_weight           = 16.813            ; if ( PMT_K40_weight        != 0 ) { samples.push_back( "PMT_K40"        ); };  
   ScintInn_K40_weight      = 0.333988          ; if ( ScintInn_K40_weight   != 0 ) { samples.push_back( "ScintInn_K40"   ); };       
   ScintOut_K40_weight      = 0.601178          ; if ( ScintOut_K40_weight   != 0 ) { samples.push_back( "ScintOut_K40"   ); };       
   ScintPet_K40_weight      = 1.00195           ; if ( ScintPet_K40_weight   != 0 ) { samples.push_back( "ScintPet_K40"   ); };       
   MuMetal_Pa234m_weight    = 0.739038          ; if ( MuMetal_Pa234m_weight != 0 ) { samples.push_back( "MuMetal_Pa234m" ); };         
   Cd116_2b2n_m14_weight    = 4977.55           ; if ( Cd116_2b2n_m14_weight != 0 ) { samples.push_back( "Cd116_2b2n_m14" ); };         
