{
  ...
  ProcessChannel::AddDataSet ( new DataSet ( "Air_Bi214"   , 70999881900.0 ,  42850760.0*Phase1Fraction ,  42850760.0*Phase2Fraction ));
  ProcessChannel::AddDataSet ( new DataSet ( "Cd116_Bi214" ,   100000000.0 ,  61433684.0*Phase1Fraction ,  61433684.0*Phase2Fraction ));
  ProcessChannel::AddDataSet ( new DataSet ( "Mylar_Bi214" ,   100000000.0 ,  63403711.0*Phase1Fraction ,  63403711.0*Phase2Fraction ));
  ProcessChannel::AddDataSet ( new DataSet ( "SFoil_Bi214" ,   109500000.0 ,  69882503.0*Phase1Fraction ,  69882503.0*Phase2Fraction ));
  ProcessChannel::AddDataSet ( new DataSet ( "SScin_Bi214" ,   799996700.0 , 107254794.0*Phase1Fraction , 107254794.0*Phase2Fraction ));
  ProcessChannel::AddDataSet ( new DataSet ( "SWire_Bi214" ,  1449494000.0 , 779772777.0*Phase1Fraction , 779772777.0*Phase2Fraction ));
