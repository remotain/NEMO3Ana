{
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "cBB"       , "cBB"                          ,  0 , 3.66977e-01 , 0.1 ) ); //DataManagement::FindParameter( "cBB"                ) -> SetFix();  
	...
	//////////////////////////////////////////////////////////////////////////////		
	{
		...
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_min_e_trackLength" ) );      
		...
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_max_e_trackLength" ) );      
		...
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_min_e_trackCurvature" ) );      
		...
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_max_e_trackCurvature" ) );      
		...
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_probInt" ) );      
		...
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_min_e_vtx_z" ) );      
		...
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_max_e_vtx_z" ) );   
		...
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_min_e_vtx_s" ) );      
		...
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_max_e_vtx_s" ) );      
		...
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_vtx_dr" ) );      
		...
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , hcoll->Find( "Cd116_2b2n_m14_h_vtx_dz" ) ); 
	...
	
	{
		...
		TH1F * Cd116_2b2n_m14_h_e_energy       = (TH1F*) hcoll->Find( "Cd116_2b2n_m14_h_min_e_energy"       )->Clone( "Cd116_2b2n_m14_h_e_energy"        ) ; Cd116_2b2n_m14_h_e_energy        -> Add ( (TH1F*) hcoll->Find( "Cd116_2b2n_m14_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m14"   ) , Cd116_2b2n_m14_h_e_energy       );
    			
		
	}
	
	tot_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); tot_e_energy -> SetLogScale(kTRUE);
    tot_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );

	e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); e_energy -> SetLogScale(kTRUE);
    e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );


	min_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); min_e_energy -> SetLogScale(kTRUE);
	min_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );
	min_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); min_e_track -> SetLogScale(kTRUE);
	min_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );
	min_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); min_e_curv -> SetLogScale(kTRUE);
	min_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );

	max_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); max_e_energy -> SetLogScale(kTRUE);
	max_e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );
	max_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); max_e_track -> SetLogScale(kTRUE);
	max_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );
	max_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); max_e_curv -> SetLogScale(kTRUE);
	max_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  );

	cosTheta     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); cosTheta -> SetLogScale(kTRUE);
	cosTheta     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );
		
	pInt         -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf"  ); pInt -> SetLogScale(kTRUE);
	pInt         -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	

	min_e_vtx_s -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	
	max_e_vtx_s -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	
	min_e_vtx_z -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	
	max_e_vtx_z -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	

	vtx_dr -> SetLogScale(kTRUE); vtx_dr -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf" );	
	vtx_dz -> SetLogScale(kTRUE); vtx_dz -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm.pdf)" );	
