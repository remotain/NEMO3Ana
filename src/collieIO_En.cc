...
int main(int argc, char* argv[]) {
    ...
    /*  2 */ double Cd116_Bi212_weight    = 3.00708           ; TH1D *  Cd116_Bi212     = 0; int Cd116_Bi212_i    ; if( Cd116_Bi212_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Bi212"    ); fdir->cd(); Cd116_Bi212      = (TH1D *) fdir->Get("Cd116_Bi212_h_tot_e_energy"    ) -> Clone( "Cd116_Bi212"    ) ; Cd116_Bi212    -> Sumw2() ; Cd116_Bi212    -> Scale( Cd116_Bi212_weight    / Cd116_Bi212     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi212"   ); vbkgd.push_back( Cd116_Bi212    ); Cd116_Bi212_i    = index; index++; };
    /*  3 */ double Cd116_Bi214_weight    = 18.1504           ; TH1D *  Cd116_Bi214     = 0; int Cd116_Bi214_i    ; if( Cd116_Bi214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Bi214"    ); fdir->cd(); Cd116_Bi214      = (TH1D *) fdir->Get("Cd116_Bi214_h_tot_e_energy"    ) -> Clone( "Cd116_Bi214"    ) ; Cd116_Bi214    -> Sumw2() ; Cd116_Bi214    -> Scale( Cd116_Bi214_weight    / Cd116_Bi214     ->Integral() ) ; bkgdNames.push_back("Cd116_Bi214"   ); vbkgd.push_back( Cd116_Bi214    ); Cd116_Bi214_i    = index; index++; };
    /*  4 */ double Cd116_Pb214_weight    = 0.186417          ; TH1D *  Cd116_Pb214     = 0; int Cd116_Pb214_i    ; if( Cd116_Pb214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Cd116_Pb214_VT" ); fdir->cd(); Cd116_Pb214      = (TH1D *) fdir->Get("Cd116_Pb214_VT_h_tot_e_energy" ) -> Clone( "Cd116_Pb214"    ) ; Cd116_Pb214    -> Sumw2() ; Cd116_Pb214    -> Scale( Cd116_Pb214_weight    / Cd116_Pb214     ->Integral() ) ; bkgdNames.push_back("Cd116_Pb214"   ); vbkgd.push_back( Cd116_Pb214    ); Cd116_Pb214_i    = index; index++; };
    ...
    /*  6 */ double Mylar_Pb214_weight    = 0.496238          ; TH1D *  Mylar_Pb214     = 0; int Mylar_Pb214_i    ; if( Mylar_Pb214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("Mylar_Pb214"    ); fdir->cd(); Mylar_Pb214      = (TH1D *) fdir->Get("Mylar_Pb214_h_tot_e_energy"    ) -> Clone( "Mylar_Pb214"    ) ; Mylar_Pb214    -> Sumw2() ; Mylar_Pb214    -> Scale( Mylar_Pb214_weight    / Mylar_Pb214     ->Integral() ) ; bkgdNames.push_back("Mylar_Pb214"   ); vbkgd.push_back( Mylar_Pb214    ); Mylar_Pb214_i    = index; index++; };
    ...
    /* 12 */ double SScin_Bi214_weight    = 0.0510754         ; TH1D *  SScin_Bi214     = 0; int SScin_Bi214_i    ; if( SScin_Bi214_weight    != 0 ) { fdir = (TDirectory *) infile->Get("SScin_Bi214"    ); fdir->cd(); SScin_Bi214      = (TH1D *) fdir->Get("SScin_Bi214_h_tot_e_energy"    ) -> Clone( "SScin_Bi214"    ) ; SScin_Bi214    -> Sumw2() ; SScin_Bi214    -> Scale( SScin_Bi214_weight    / SScin_Bi214     ->Integral() ) ; bkgdNames.push_back("SScin_Bi214"   ); vbkgd.push_back( SScin_Bi214    ); SScin_Bi214_i    = index; index++; };
    ...
    /* 20 */ double FeShield_Tl208_weight = 0.859465          ; TH1D *  FeShield_Tl208  = 0; int FeShield_Tl208_i ; if( FeShield_Tl208_weight != 0 ) { fdir = (TDirectory *) infile->Get("FeShield_Tl208" ); fdir->cd(); FeShield_Tl208   = (TH1D *) fdir->Get("FeShield_Tl208_h_tot_e_energy" ) -> Clone( "FeShield_Tl208" ) ; FeShield_Tl208 -> Sumw2() ; FeShield_Tl208 -> Scale( FeShield_Tl208_weight / FeShield_Tl208  ->Integral() ) ; bkgdNames.push_back("FeShield_Tl208"); vbkgd.push_back( FeShield_Tl208 ); FeShield_Tl208_i = index; index++; };
    ...
    /* 25 */ double PMT_Bi214_weight      = 27.9661           ; TH1D *  PMT_Bi214       = 0; int PMT_Bi214_i      ; if( PMT_Bi214_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Bi214"      ); fdir->cd(); PMT_Bi214        = (TH1D *) fdir->Get("PMT_Bi214_h_tot_e_energy"      ) -> Clone( "PMT_Bi214"      ) ; PMT_Bi214      -> Sumw2() ; PMT_Bi214      -> Scale( PMT_Bi214_weight      / PMT_Bi214       ->Integral() ) ; bkgdNames.push_back("PMT_Bi214"     ); vbkgd.push_back( PMT_Bi214      ); PMT_Bi214_i      = index; index++; };
    /* 26 */ double PMT_Tl208_weight      = 22.923            ; TH1D *  PMT_Tl208       = 0; int PMT_Tl208_i      ; if( PMT_Tl208_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Tl208"      ); fdir->cd(); PMT_Tl208        = (TH1D *) fdir->Get("PMT_Tl208_h_tot_e_energy"      ) -> Clone( "PMT_Tl208"      ) ; PMT_Tl208      -> Sumw2() ; PMT_Tl208      -> Scale( PMT_Tl208_weight      / PMT_Tl208       ->Integral() ) ; bkgdNames.push_back("PMT_Tl208"     ); vbkgd.push_back( PMT_Tl208      ); PMT_Tl208_i      = index; index++; };
    /* 27 */ double PMT_Ac228_weight      = 3.60712           ; TH1D *  PMT_Ac228       = 0; int PMT_Ac228_i      ; if( PMT_Ac228_weight      != 0 ) { fdir = (TDirectory *) infile->Get("PMT_Ac228"      ); fdir->cd(); PMT_Ac228        = (TH1D *) fdir->Get("PMT_Ac228_h_tot_e_energy"      ) -> Clone( "PMT_Ac228"      ) ; PMT_Ac228      -> Sumw2() ; PMT_Ac228      -> Scale( PMT_Ac228_weight      / PMT_Ac228       ->Integral() ) ; bkgdNames.push_back("PMT_Ac228"     ); vbkgd.push_back( PMT_Ac228      ); PMT_Ac228_i      = index; index++; };
    ...
    /* 29 */ double ScintInn_K40_weight   = 0.333988          ; TH1D *  ScintInn_K40    = 0; int ScintInn_K40_i   ; if( ScintInn_K40_weight   != 0 ) { fdir = (TDirectory *) infile->Get("ScintInn_K40"   ); fdir->cd(); ScintInn_K40     = (TH1D *) fdir->Get("ScintInn_K40_h_tot_e_energy"   ) -> Clone( "ScintInn_K40"   ) ; ScintInn_K40   -> Sumw2() ; ScintInn_K40   -> Scale( ScintInn_K40_weight   / ScintInn_K40    ->Integral() ) ; bkgdNames.push_back("ScintInn_K40"  ); vbkgd.push_back( ScintInn_K40   ); ScintInn_K40_i   = index; index++; };
    /* 30 */ double ScintOut_K40_weight   = 0.601178          ; TH1D *  ScintOut_K40    = 0; int ScintOut_K40_i   ; if( ScintOut_K40_weight   != 0 ) { fdir = (TDirectory *) infile->Get("ScintOut_K40"   ); fdir->cd(); ScintOut_K40     = (TH1D *) fdir->Get("ScintOut_K40_h_tot_e_energy"   ) -> Clone( "ScintOut_K40"   ) ; ScintOut_K40   -> Sumw2() ; ScintOut_K40   -> Scale( ScintOut_K40_weight   / ScintOut_K40    ->Integral() ) ; bkgdNames.push_back("ScintOut_K40"  ); vbkgd.push_back( ScintOut_K40   ); ScintOut_K40_i   = index; index++; };
    /* 31 */ double ScintPet_K40_weight   = 1.00195           ; TH1D *  ScintPet_K40    = 0; int ScintPet_K40_i   ; if( ScintPet_K40_weight   != 0 ) { fdir = (TDirectory *) infile->Get("ScintPet_K40"   ); fdir->cd(); ScintPet_K40     = (TH1D *) fdir->Get("ScintPet_K40_h_tot_e_energy"   ) -> Clone( "ScintPet_K40"   ) ; ScintPet_K40   -> Sumw2() ; ScintPet_K40   -> Scale( ScintPet_K40_weight   / ScintPet_K40    ->Integral() ) ; bkgdNames.push_back("ScintPet_K40"  ); vbkgd.push_back( ScintPet_K40   ); ScintPet_K40_i   = index; index++; };
