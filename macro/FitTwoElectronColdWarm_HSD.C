{
	...
	tot_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf(" ); tot_e_energy_P1_cold -> SetLogScale(kTRUE);
    tot_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	min_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_energy_P1_cold -> SetLogScale(kTRUE);
	min_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	max_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_energy_P1_cold -> SetLogScale(kTRUE);
	max_e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	cosTheta_P1_cold     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); cosTheta_P1_cold -> SetLogScale(kTRUE);
	cosTheta_P1_cold     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );

	tot_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); tot_e_energy_P2_cold -> SetLogScale(kTRUE);
    tot_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	min_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_energy_P2_cold -> SetLogScale(kTRUE);
	min_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	max_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_energy_P2_cold -> SetLogScale(kTRUE);
	max_e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	cosTheta_P2_cold     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); cosTheta_P2_cold -> SetLogScale(kTRUE);
	cosTheta_P2_cold     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );

	tot_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); tot_e_energy_P1_warm -> SetLogScale(kTRUE);
    tot_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	min_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_energy_P1_warm -> SetLogScale(kTRUE);
	min_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	max_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_energy_P1_warm -> SetLogScale(kTRUE);
	max_e_energy_P1_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	cosTheta_P1_warm     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); cosTheta_P1_warm -> SetLogScale(kTRUE);
	cosTheta_P1_warm     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );

	tot_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); tot_e_energy_P2_warm -> SetLogScale(kTRUE);
    tot_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	min_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_energy_P2_warm -> SetLogScale(kTRUE);
	min_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	max_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_energy_P2_warm -> SetLogScale(kTRUE);
	max_e_energy_P2_warm -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	cosTheta_P2_warm     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); cosTheta_P2_warm -> SetLogScale(kTRUE);
	cosTheta_P2_warm     -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );	
	...
	Observable * min_e_track     = new Observable("min_e_track"  , "2e - Track Length_{e,min}" , kAll , hcoll->Find( "Data_h_min_e_trackLength" ) ); min_e_track -> SetLogScale(kFALSE); min_e_track -> AddGroupAll(DataManagement::GetGroupCollection()); min_e_track  -> SetDrawGroup(kTRUE);
	Observable * max_e_track     = new Observable("max_e_track"  , "2e - Track Length_{e,max}" , kAll , hcoll->Find( "Data_h_max_e_trackLength" ) ); max_e_track -> SetLogScale(kFALSE); max_e_track -> AddGroupAll(DataManagement::GetGroupCollection()); max_e_track  -> SetDrawGroup(kTRUE);
	Observable * min_e_curv      = new Observable("min_e_curv"   , "2e - Track Curvature_{e,min}" , kAll , hcoll->Find( "Data_h_min_e_trackCurvature" ) ); min_e_curv -> SetLogScale(kFALSE); min_e_curv -> AddGroupAll(DataManagement::GetGroupCollection()); min_e_curv -> SetDrawGroup(kTRUE);
	Observable * max_e_curv      = new Observable("max_e_curv"   , "2e - Track Curvature_{e,max}" , kAll , hcoll->Find( "Data_h_max_e_trackCurvature" ) ); max_e_curv -> SetLogScale(kFALSE); max_e_curv -> AddGroupAll(DataManagement::GetGroupCollection()); max_e_curv -> SetDrawGroup(kTRUE);
	Observable * pInt            = new Observable("pInt"         , "Internal probability" , kAll , hcoll->Find( "Data_h_probInt"      ) ); pInt         -> SetLogScale(kFALSE); pInt         -> AddGroupAll(DataManagement::GetGroupCollection()); pInt         -> SetDrawGroup(kTRUE);

	Observable * min_e_vtx_z  = new Observable("min_e_vtx_z"   , "2e - Vertex Z_{e,min}" , kAll , hcoll->Find( "Data_h_min_e_vtx_z" ) ); min_e_vtx_z -> SetLogScale(kFALSE); min_e_vtx_z -> AddGroupAll(DataManagement::GetGroupCollection()); min_e_vtx_z -> SetDrawGroup(kTRUE);
	Observable * max_e_vtx_z  = new Observable("max_e_vtx_z"   , "2e - Vertex Z_{e,max}" , kAll , hcoll->Find( "Data_h_max_e_vtx_z" ) ); max_e_vtx_z -> SetLogScale(kFALSE); max_e_vtx_z -> AddGroupAll(DataManagement::GetGroupCollection()); max_e_vtx_z -> SetDrawGroup(kTRUE);
	Observable * min_e_vtx_s  = new Observable("min_e_vtx_s"   , "2e - Vertex S_{e,min}" , kAll , hcoll->Find( "Data_h_min_e_vtx_s" ) ); min_e_vtx_s -> SetLogScale(kFALSE); min_e_vtx_s -> AddGroupAll(DataManagement::GetGroupCollection()); min_e_vtx_s -> SetDrawGroup(kTRUE);
	Observable * max_e_vtx_s  = new Observable("max_e_vtx_s"   , "2e - Vertex S_{e,max}" , kAll , hcoll->Find( "Data_h_max_e_vtx_s" ) ); max_e_vtx_s -> SetLogScale(kFALSE); max_e_vtx_s -> AddGroupAll(DataManagement::GetGroupCollection()); max_e_vtx_s -> SetDrawGroup(kTRUE);

	Observable * vtx_dr       = new Observable("vtx_dr"    , "Vertex #Delta r"      , kAll , hcoll->Find( "Data_h_vtx_dr"       ) ); vtx_dr    -> SetLogScale(kFALSE); vtx_dr    -> AddGroupAll(DataManagement::GetGroupCollection()); vtx_dr    -> SetDrawGroup(kTRUE);
	Observable * vtx_dz       = new Observable("vtx_dz"    , "Vertex #Delta z"      , kAll , hcoll->Find( "Data_h_vtx_dz"       ) ); vtx_dz    -> SetLogScale(kFALSE); vtx_dz    -> AddGroupAll(DataManagement::GetGroupCollection()); vtx_dz    -> SetDrawGroup(kTRUE);		
	...
	
	{
		...
		hcoll->Find( "Cd116_K40_h_min_e_trackLength_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_trackLength_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_min_e_trackLength_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_trackLength_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P2_warm"    ) );
	
		hcoll->Find( "Cd116_K40_h_max_e_trackLength_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_trackLength_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_max_e_trackLength_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_trackLength_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P2_warm"    ) );
	
		hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P2_warm"    ) );
	
		hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P2_warm"    ) );
	
		hcoll->Find( "Cd116_K40_h_probInt_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_probInt_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_probInt_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_probInt_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_probInt_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_probInt_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_probInt_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_probInt_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_probInt_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_probInt_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_probInt_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_probInt_P2_warm"    ) );

		hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P2_warm"    ) );

		hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P2_warm"    ) );

		hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P2_warm"    ) );

		hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P1_cold"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P2_cold"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P1_cold"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P2_cold"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P1_cold"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P2_cold"    ) );
		hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P1_warm"      ) -> Add( hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P2_warm"      ) );
		hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P1_warm"   ) -> Add( hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P2_warm"   ) );
		hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P1_warm"    ) -> Add( hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P2_warm"    ) );
	...
	//////////////////////////////////////////////////////////////////////////////		
	{
		...
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_min_e_trackLength" ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_min_e_trackLength"    ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_min_e_trackLength"    ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_min_e_trackLength_P1_cold"      ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P1_cold"   ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P1_cold"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_min_e_trackLength_P1_warm"      ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_min_e_trackLength_P1_warm"   ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_min_e_trackLength_P1_warm"    ) );
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_min_e_trackLength"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_trackLength_P1"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_trackLength_P2"    ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_min_e_trackLength" ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_min_e_trackLength" ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_min_e_trackLength" ) );      		
		min_e_track -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_min_e_trackLength"   ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_min_e_trackLength_P1"      ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_min_e_trackLength_P1"      ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_min_e_trackLength_P1"      ) );   
		min_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_min_e_trackLength"      ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_min_e_trackLength"      ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_min_e_trackLength"      ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_min_e_trackLength"        ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_min_e_trackLength"   ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_min_e_trackLength"   ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_min_e_trackLength"   ) );      
		min_e_track -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_min_e_trackLength"   ) );      	
		min_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_min_e_trackLength" ) );      
    	
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_max_e_trackLength" ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_max_e_trackLength"    ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_max_e_trackLength"    ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_max_e_trackLength_P1_cold"      ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P1_cold"   ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P1_cold"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_max_e_trackLength_P1_warm"      ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_max_e_trackLength_P1_warm"   ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_max_e_trackLength_P1_warm"    ) );
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_max_e_trackLength_P2"    ) );   	
		max_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_max_e_trackLength"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_trackLength_P1"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_max_e_trackLength_P2"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_max_e_trackLength_P2"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_trackLength_P2"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_max_e_trackLength_P2"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_trackLength_P2"    ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_max_e_trackLength" ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_max_e_trackLength" ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_max_e_trackLength" ) );      		
		max_e_track -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_max_e_trackLength"   ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_max_e_trackLength_P1"      ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_max_e_trackLength_P1"      ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_max_e_trackLength_P1"      ) );   
		max_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_max_e_trackLength"      ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_max_e_trackLength"      ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_max_e_trackLength"      ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_max_e_trackLength"        ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_max_e_trackLength"   ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_max_e_trackLength"   ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_max_e_trackLength"   ) );      
		max_e_track -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_max_e_trackLength"   ) );      	
		max_e_track -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_max_e_trackLength" ) );      
    	
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_min_e_trackCurvature" ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_min_e_trackCurvature"    ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_min_e_trackCurvature"    ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P1_cold"      ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P1_cold"   ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P1_cold"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_min_e_trackCurvature_P1_warm"      ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_min_e_trackCurvature_P1_warm"   ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_min_e_trackCurvature_P1_warm"    ) );
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_min_e_trackCurvature"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_trackCurvature_P1"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_trackCurvature_P2"    ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_min_e_trackCurvature" ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_min_e_trackCurvature" ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_min_e_trackCurvature" ) );      		
		min_e_curv -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_min_e_trackCurvature"   ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_min_e_trackCurvature_P1"      ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_min_e_trackCurvature_P1"      ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_min_e_trackCurvature_P1"      ) );   
		min_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_min_e_trackCurvature"      ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_min_e_trackCurvature"      ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_min_e_trackCurvature"      ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_min_e_trackCurvature"        ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_min_e_trackCurvature"   ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_min_e_trackCurvature"   ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_min_e_trackCurvature"   ) );      
		min_e_curv -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_min_e_trackCurvature"   ) );      	
		min_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_min_e_trackCurvature" ) );      
    	
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_max_e_trackCurvature" ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_max_e_trackCurvature"    ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_max_e_trackCurvature"    ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P1_cold"      ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P1_cold"   ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P1_cold"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_max_e_trackCurvature_P1_warm"      ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_max_e_trackCurvature_P1_warm"   ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_max_e_trackCurvature_P1_warm"    ) );
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_max_e_trackCurvature_P2"    ) );   	
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_max_e_trackCurvature"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_trackCurvature_P1"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_max_e_trackCurvature_P2"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_max_e_trackCurvature_P2"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_trackCurvature_P2"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_max_e_trackCurvature_P2"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_trackCurvature_P2"    ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_max_e_trackCurvature" ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_max_e_trackCurvature" ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_max_e_trackCurvature" ) );      		
		max_e_curv -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_max_e_trackCurvature"   ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_max_e_trackCurvature_P1"      ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_max_e_trackCurvature_P1"      ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_max_e_trackCurvature_P1"      ) );   
		max_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_max_e_trackCurvature"      ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_max_e_trackCurvature"      ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_max_e_trackCurvature"      ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_max_e_trackCurvature"        ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_max_e_trackCurvature"   ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_max_e_trackCurvature"   ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_max_e_trackCurvature"   ) );      
		max_e_curv -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_max_e_trackCurvature"   ) );      	
		max_e_curv -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_max_e_trackCurvature" ) );      
		...
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_probInt" ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_probInt"    ) );
		pInt -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_probInt"    ) );
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_probInt_P1_cold"      ) );
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_probInt_P1_cold"   ) );
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_probInt_P1_cold"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_probInt_P1_warm"      ) );
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_probInt_P1_warm"   ) );
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_probInt_P1_warm"    ) );
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_probInt_P1" ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_probInt_P2" ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_probInt"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_probInt_P1"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_probInt_P1"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_probInt_P1"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_probInt_P1"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_probInt_P1"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_probInt_P2"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_probInt_P2"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_probInt_P2"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_probInt_P2"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_probInt_P2"    ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_probInt" ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_probInt" ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_probInt" ) );      		
		pInt -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_probInt"   ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_probInt_P1"      ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_probInt_P1"      ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_probInt_P1"      ) );   
		pInt -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_probInt"      ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_probInt"      ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_probInt"      ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_probInt"        ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_probInt"   ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_probInt"   ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_probInt"   ) );      
		pInt -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_probInt"   ) );      	
		pInt -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_probInt" ) );      

		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_min_e_vtx_z" ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_min_e_vtx_z"    ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_min_e_vtx_z"    ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P1_cold"      ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P1_cold"   ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P1_cold"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_min_e_vtx_z_P1_warm"      ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_z_P1_warm"   ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_min_e_vtx_z_P1_warm"    ) );
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_min_e_vtx_z_P1" ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_min_e_vtx_z_P2" ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_min_e_vtx_z"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_min_e_vtx_z_P1"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_min_e_vtx_z_P1"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_vtx_z_P1"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_min_e_vtx_z_P1"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_vtx_z_P1"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_min_e_vtx_z_P2"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_min_e_vtx_z_P2"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_vtx_z_P2"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_min_e_vtx_z_P2"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_vtx_z_P2"    ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_min_e_vtx_z" ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_min_e_vtx_z" ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_min_e_vtx_z" ) );      		
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_min_e_vtx_z"   ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_min_e_vtx_z_P1"      ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_min_e_vtx_z_P1"      ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_min_e_vtx_z_P1"      ) );   
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_min_e_vtx_z"      ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_min_e_vtx_z"      ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_min_e_vtx_z"      ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_min_e_vtx_z"        ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_min_e_vtx_z"   ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_min_e_vtx_z"   ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_min_e_vtx_z"   ) );      
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_min_e_vtx_z"   ) );      	
		min_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_min_e_vtx_z" ) );      

		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_max_e_vtx_z" ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_max_e_vtx_z"    ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_max_e_vtx_z"    ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P1_cold"      ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P1_cold"   ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P1_cold"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_max_e_vtx_z_P1_warm"      ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_z_P1_warm"   ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_max_e_vtx_z_P1_warm"    ) );
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_max_e_vtx_z_P1" ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_max_e_vtx_z_P2" ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_max_e_vtx_z"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_max_e_vtx_z_P1"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_max_e_vtx_z_P1"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_vtx_z_P1"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_max_e_vtx_z_P1"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_vtx_z_P1"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_max_e_vtx_z_P2"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_max_e_vtx_z_P2"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_vtx_z_P2"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_max_e_vtx_z_P2"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_vtx_z_P2"    ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_max_e_vtx_z" ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_max_e_vtx_z" ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_max_e_vtx_z" ) );      		
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_max_e_vtx_z"   ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_max_e_vtx_z_P1"      ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_max_e_vtx_z_P1"      ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_max_e_vtx_z_P1"      ) );   
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_max_e_vtx_z"      ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_max_e_vtx_z"      ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_max_e_vtx_z"      ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_max_e_vtx_z"        ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_max_e_vtx_z"   ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_max_e_vtx_z"   ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_max_e_vtx_z"   ) );      
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_max_e_vtx_z"   ) );      	
		max_e_vtx_z -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_max_e_vtx_z" ) );   

		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_min_e_vtx_s" ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_min_e_vtx_s"    ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_min_e_vtx_s"    ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P1_cold"      ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P1_cold"   ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P1_cold"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_min_e_vtx_s_P1_warm"      ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_min_e_vtx_s_P1_warm"   ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_min_e_vtx_s_P1_warm"    ) );
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_min_e_vtx_s_P1" ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_min_e_vtx_s_P2" ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_min_e_vtx_s"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_min_e_vtx_s_P1"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_min_e_vtx_s_P1"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_vtx_s_P1"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_min_e_vtx_s_P1"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_vtx_s_P1"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_min_e_vtx_s_P2"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_min_e_vtx_s_P2"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_min_e_vtx_s_P2"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_min_e_vtx_s_P2"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_min_e_vtx_s_P2"    ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_min_e_vtx_s" ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_min_e_vtx_s" ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_min_e_vtx_s" ) );      		
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_min_e_vtx_s"   ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_min_e_vtx_s_P1"      ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_min_e_vtx_s_P1"      ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_min_e_vtx_s_P1"      ) );   
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_min_e_vtx_s"      ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_min_e_vtx_s"      ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_min_e_vtx_s"      ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_min_e_vtx_s"        ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_min_e_vtx_s"   ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_min_e_vtx_s"   ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_min_e_vtx_s"   ) );      
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_min_e_vtx_s"   ) );      	
		min_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_min_e_vtx_s" ) );      

		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_max_e_vtx_s" ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_max_e_vtx_s"    ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_max_e_vtx_s"    ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P1_cold"      ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P1_cold"   ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P1_cold"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_max_e_vtx_s_P1_warm"      ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_max_e_vtx_s_P1_warm"   ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_max_e_vtx_s_P1_warm"    ) );
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_max_e_vtx_s_P1" ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_max_e_vtx_s_P2" ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_max_e_vtx_s"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_max_e_vtx_s_P1"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_max_e_vtx_s_P1"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_vtx_s_P1"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_max_e_vtx_s_P1"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_vtx_s_P1"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_max_e_vtx_s_P2"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_max_e_vtx_s_P2"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_max_e_vtx_s_P2"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_max_e_vtx_s_P2"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_max_e_vtx_s_P2"    ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_max_e_vtx_s" ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_max_e_vtx_s" ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_max_e_vtx_s" ) );      		
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_max_e_vtx_s"   ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_max_e_vtx_s_P1"      ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_max_e_vtx_s_P1"      ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_max_e_vtx_s_P1"      ) );   
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_max_e_vtx_s"      ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_max_e_vtx_s"      ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_max_e_vtx_s"      ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_max_e_vtx_s"        ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_max_e_vtx_s"   ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_max_e_vtx_s"   ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_max_e_vtx_s"   ) );      
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_max_e_vtx_s"   ) );      	
		max_e_vtx_s -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_max_e_vtx_s" ) );      


		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_vtx_dr" ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_vtx_dr"    ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_vtx_dr"    ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_vtx_dr_P1_cold"      ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_vtx_dr_P1_cold"   ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_vtx_dr_P1_cold"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_vtx_dr_P1_warm"      ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_vtx_dr_P1_warm"   ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_vtx_dr_P1_warm"    ) );
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_vtx_dr_P1" ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_vtx_dr_P2" ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_vtx_dr"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_vtx_dr_P1"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_vtx_dr_P1"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_vtx_dr_P1"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_vtx_dr_P1"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_vtx_dr_P1"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_vtx_dr_P2"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_vtx_dr_P2"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_vtx_dr_P2"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_vtx_dr_P2"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_vtx_dr_P2"    ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_vtx_dr" ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_vtx_dr" ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_vtx_dr" ) );      		
		vtx_dr -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_vtx_dr"   ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_vtx_dr_P1"      ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_vtx_dr_P1"      ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_vtx_dr_P1"      ) );   
		vtx_dr -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_vtx_dr"      ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_vtx_dr"      ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_vtx_dr"      ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_vtx_dr"        ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_vtx_dr"   ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_vtx_dr"   ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_vtx_dr"   ) );      
		vtx_dr -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_vtx_dr"   ) );      	
		vtx_dr -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_vtx_dr" ) );      

		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , hcoll->Find( "Cd116_Tl208_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , hcoll->Find( "Cd116_Ac228_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , hcoll->Find( "Cd116_Bi212_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , hcoll->Find( "Cd116_Bi214_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , hcoll->Find( "Cd116_Pb214_VT_h_vtx_dz" ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , hcoll->Find( "Mylar_Bi214_h_vtx_dz"    ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , hcoll->Find( "Mylar_Pb214_h_vtx_dz"    ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , hcoll->Find( "Cd116_K40_h_vtx_dz_P1_cold"      ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , hcoll->Find( "Cd116_Pa234m_h_vtx_dz_P1_cold"   ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , hcoll->Find( "SFoil_Bi210_h_vtx_dz_P1_cold"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , hcoll->Find( "Cd116_K40_h_vtx_dz_P1_warm"      ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , hcoll->Find( "Cd116_Pa234m_h_vtx_dz_P1_warm"   ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , hcoll->Find( "SFoil_Bi210_h_vtx_dz_P1_warm"    ) );
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , hcoll->Find( "SWire_Bi210_h_vtx_dz_P1" ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , hcoll->Find( "SWire_Bi210_h_vtx_dz_P2" ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , hcoll->Find( "SScin_Bi210_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , hcoll->Find( "SScin_Bi214_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , hcoll->Find( "SScin_Pb214_h_vtx_dz"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , hcoll->Find( "SWire_Tl208_h_vtx_dz_P1"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , hcoll->Find( "SWire_Bi214_h_vtx_dz_P1"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , hcoll->Find( "SFoil_Bi214_h_vtx_dz_P1"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , hcoll->Find( "SWire_Pb214_h_vtx_dz_P1"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , hcoll->Find( "SFoil_Pb214_h_vtx_dz_P1"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , hcoll->Find( "SWire_Tl208_h_vtx_dz_P2"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , hcoll->Find( "SWire_Bi214_h_vtx_dz_P2"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , hcoll->Find( "SFoil_Bi214_h_vtx_dz_P2"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , hcoll->Find( "SWire_Pb214_h_vtx_dz_P2"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , hcoll->Find( "SFoil_Pb214_h_vtx_dz_P2"    ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , hcoll->Find( "FeShield_Bi214_h_vtx_dz" ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , hcoll->Find( "FeShield_Tl208_h_vtx_dz" ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , hcoll->Find( "FeShield_Ac228_h_vtx_dz" ) );      		
		vtx_dz -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , hcoll->Find( "CuTower_Co60_h_vtx_dz"   ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , hcoll->Find( "Air_Bi214_h_vtx_dz_P1"      ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , hcoll->Find( "Air_Pb214_h_vtx_dz_P1"      ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , hcoll->Find( "Air_Tl208_h_vtx_dz_P1"      ) );   
		vtx_dz -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , hcoll->Find( "PMT_Bi214_h_vtx_dz"      ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , hcoll->Find( "PMT_Tl208_h_vtx_dz"      ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , hcoll->Find( "PMT_Ac228_h_vtx_dz"      ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , hcoll->Find( "PMT_K40_h_vtx_dz"        ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , hcoll->Find( "ScintInn_K40_h_vtx_dz"   ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , hcoll->Find( "ScintOut_K40_h_vtx_dz"   ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , hcoll->Find( "ScintPet_K40_h_vtx_dz"   ) );      
		vtx_dz -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , hcoll->Find( "MuMetal_Pa234m_h_vtx_dz"   ) );      	
		vtx_dz -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"   ) , hcoll->Find( "Cd116_2b2n_m4_h_vtx_dz" ) ); 
	...
	
	{
		...
		// This is a trick
		TH1F * Data_h_e_energy = (TH1F*) hcoll->Find( "Data_h_min_e_energy" )->Clone("Data_h_e_energy"); Data_h_e_energy -> Add( (TH1F*) hcoll->Find( "Data_h_max_e_energy" ) );
		Observable * e_energy = new Observable("e_energy" , "2e - E_{e}" , kAll , Data_h_e_energy ); e_energy -> SetLogScale(kFALSE); e_energy -> AddGroupAll(DataManagement::GetGroupCollection()); e_energy -> SetDrawGroup(kTRUE);
		
		TH1F * Cd116_Tl208_h_e_energy          = (TH1F*) hcoll->Find( "Cd116_Tl208_h_min_e_energy"          )->Clone( "Cd116_Tl208_h_e_energy"           ) ; Cd116_Tl208_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Cd116_Tl208_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Tl208"      ) , Cd116_Tl208_h_e_energy          );
		TH1F * Cd116_Ac228_h_e_energy          = (TH1F*) hcoll->Find( "Cd116_Ac228_h_min_e_energy"          )->Clone( "Cd116_Ac228_h_e_energy"           ) ; Cd116_Ac228_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Cd116_Ac228_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Ac228"      ) , Cd116_Ac228_h_e_energy          );
		TH1F * Cd116_Bi212_h_e_energy          = (TH1F*) hcoll->Find( "Cd116_Bi212_h_min_e_energy"          )->Clone( "Cd116_Bi212_h_e_energy"           ) ; Cd116_Bi212_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Cd116_Bi212_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Bi212"      ) , Cd116_Bi212_h_e_energy          );
		TH1F * Cd116_Bi214_h_e_energy          = (TH1F*) hcoll->Find( "Cd116_Bi214_h_min_e_energy"          )->Clone( "Cd116_Bi214_h_e_energy"           ) ; Cd116_Bi214_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Cd116_Bi214_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Bi214"      ) , Cd116_Bi214_h_e_energy          );
		TH1F * Cd116_Pb214_VT_h_e_energy       = (TH1F*) hcoll->Find( "Cd116_Pb214_VT_h_min_e_energy"       )->Clone( "Cd116_Pb214_VT_h_e_energy"        ) ; Cd116_Pb214_VT_h_e_energy       -> Add ( (TH1F*) hcoll->Find( "Cd116_Pb214_VT_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Pb214"      ) , Cd116_Pb214_VT_h_e_energy       );
		TH1F * Mylar_Bi214_h_e_energy          = (TH1F*) hcoll->Find( "Mylar_Bi214_h_min_e_energy"          )->Clone( "Mylar_Bi214_h_e_energy"           ) ; Mylar_Bi214_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Mylar_Bi214_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Mylar_Bi214"      ) , Mylar_Bi214_h_e_energy          );
		TH1F * Mylar_Pb214_h_e_energy          = (TH1F*) hcoll->Find( "Mylar_Pb214_h_min_e_energy"          )->Clone( "Mylar_Pb214_h_e_energy"           ) ; Mylar_Pb214_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "Mylar_Pb214_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "Mylar_Pb214"      ) , Mylar_Pb214_h_e_energy          );
		TH1F * Cd116_K40_h_e_energy_P1_cold    = (TH1F*) hcoll->Find( "Cd116_K40_h_min_e_energy_P1_cold"    )->Clone( "Cd116_K40_h_e_energy_P1_cold"     ) ; Cd116_K40_h_e_energy_P1_cold    -> Add ( (TH1F*) hcoll->Find( "Cd116_K40_h_max_e_energy_P1_cold"    )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_K40_cold"   ) , Cd116_K40_h_e_energy_P1_cold    );
		TH1F * Cd116_Pa234m_h_e_energy_P1_cold = (TH1F*) hcoll->Find( "Cd116_Pa234m_h_min_e_energy_P1_cold" )->Clone( "Cd116_Pa234m_h_e_energy_P1_cold"  ) ; Cd116_Pa234m_h_e_energy_P1_cold -> Add ( (TH1F*) hcoll->Find( "Cd116_Pa234m_h_max_e_energy_P1_cold" )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_cold") , Cd116_Pa234m_h_e_energy_P1_cold );
		TH1F * SFoil_Bi210_h_e_energy_P1_cold  = (TH1F*) hcoll->Find( "SFoil_Bi210_h_min_e_energy_P1_cold"  )->Clone( "SFoil_Bi210_h_e_energy_P1_cold"   ) ; SFoil_Bi210_h_e_energy_P1_cold  -> Add ( (TH1F*) hcoll->Find( "SFoil_Bi210_h_max_e_energy_P1_cold"  )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_cold" ) , SFoil_Bi210_h_e_energy_P1_cold  );   
		TH1F * Cd116_K40_h_e_energy_P1_warm    = (TH1F*) hcoll->Find( "Cd116_K40_h_min_e_energy_P1_warm"    )->Clone( "Cd116_K40_h_e_energy_P1_warm"     ) ; Cd116_K40_h_e_energy_P1_warm    -> Add ( (TH1F*) hcoll->Find( "Cd116_K40_h_max_e_energy_P1_warm"    )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_K40_warm"   ) , Cd116_K40_h_e_energy_P1_warm    );
		TH1F * Cd116_Pa234m_h_e_energy_P1_warm = (TH1F*) hcoll->Find( "Cd116_Pa234m_h_min_e_energy_P1_warm" )->Clone( "Cd116_Pa234m_h_e_energy_P1_warm"  ) ; Cd116_Pa234m_h_e_energy_P1_warm -> Add ( (TH1F*) hcoll->Find( "Cd116_Pa234m_h_max_e_energy_P1_warm" )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_Pa234m_warm") , Cd116_Pa234m_h_e_energy_P1_warm );
		TH1F * SFoil_Bi210_h_e_energy_P1_warm  = (TH1F*) hcoll->Find( "SFoil_Bi210_h_min_e_energy_P1_warm"  )->Clone( "SFoil_Bi210_h_e_energy_P1_warm"   ) ; SFoil_Bi210_h_e_energy_P1_warm  -> Add ( (TH1F*) hcoll->Find( "SFoil_Bi210_h_max_e_energy_P1_warm"  )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Bi210_warm" ) , SFoil_Bi210_h_e_energy_P1_warm  );
		TH1F * SWire_Bi210_h_e_energy_P1       = (TH1F*) hcoll->Find( "SWire_Bi210_h_min_e_energy_P1"       )->Clone( "SWire_Bi210_h_e_energy_P1"        ) ; SWire_Bi210_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SWire_Bi210_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P1"   ) , SWire_Bi210_h_e_energy_P1       );
		TH1F * SWire_Bi210_h_e_energy_P2       = (TH1F*) hcoll->Find( "SWire_Bi210_h_min_e_energy_P2"       )->Clone( "SWire_Bi210_h_e_energy_P2"        ) ; SWire_Bi210_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SWire_Bi210_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Bi210_P2"   ) , SWire_Bi210_h_e_energy_P2       );
		TH1F * SScin_Bi210_h_e_energy          = (TH1F*) hcoll->Find( "SScin_Bi210_h_min_e_energy"          )->Clone( "SScin_Bi210_h_e_energy"           ) ; SScin_Bi210_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "SScin_Bi210_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "SScin_Bi210"      ) , SScin_Bi210_h_e_energy          );
		TH1F * SScin_Bi214_h_e_energy          = (TH1F*) hcoll->Find( "SScin_Bi214_h_min_e_energy"          )->Clone( "SScin_Bi214_h_e_energy"           ) ; SScin_Bi214_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "SScin_Bi214_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "SScin_Bi214"      ) , SScin_Bi214_h_e_energy          );
		TH1F * SScin_Pb214_h_e_energy          = (TH1F*) hcoll->Find( "SScin_Pb214_h_min_e_energy"          )->Clone( "SScin_Pb214_h_e_energy"           ) ; SScin_Pb214_h_e_energy          -> Add ( (TH1F*) hcoll->Find( "SScin_Pb214_h_max_e_energy"          )); e_energy -> AddComponent( DataManagement::FindComponent( "SScin_Pb214"      ) , SScin_Pb214_h_e_energy          );
		TH1F * SWire_Tl208_h_e_energy_P1       = (TH1F*) hcoll->Find( "SWire_Tl208_h_min_e_energy_P1"       )->Clone( "SWire_Tl208_h_e_energy_P1"        ) ; SWire_Tl208_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SWire_Tl208_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P1"   ) , SWire_Tl208_h_e_energy_P1       );
		TH1F * SWire_Bi214_h_e_energy_P1       = (TH1F*) hcoll->Find( "SWire_Bi214_h_min_e_energy_P1"       )->Clone( "SWire_Bi214_h_e_energy_P1"        ) ; SWire_Bi214_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SWire_Bi214_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P1"   ) , SWire_Bi214_h_e_energy_P1       );
		TH1F * SFoil_Bi214_h_e_energy_P1       = (TH1F*) hcoll->Find( "SFoil_Bi214_h_min_e_energy_P1"       )->Clone( "SFoil_Bi214_h_e_energy_P1"        ) ; SFoil_Bi214_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SFoil_Bi214_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P1"   ) , SFoil_Bi214_h_e_energy_P1       );
		TH1F * SWire_Pb214_h_e_energy_P1       = (TH1F*) hcoll->Find( "SWire_Pb214_h_min_e_energy_P1"       )->Clone( "SWire_Pb214_h_e_energy_P1"        ) ; SWire_Pb214_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SWire_Pb214_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P1"   ) , SWire_Pb214_h_e_energy_P1       );
		TH1F * SFoil_Pb214_h_e_energy_P1       = (TH1F*) hcoll->Find( "SFoil_Pb214_h_min_e_energy_P1"       )->Clone( "SFoil_Pb214_h_e_energy_P1"        ) ; SFoil_Pb214_h_e_energy_P1       -> Add ( (TH1F*) hcoll->Find( "SFoil_Pb214_h_max_e_energy_P1"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P1"   ) , SFoil_Pb214_h_e_energy_P1       );
		TH1F * SWire_Tl208_h_e_energy_P2       = (TH1F*) hcoll->Find( "SWire_Tl208_h_min_e_energy_P2"       )->Clone( "SWire_Tl208_h_e_energy_P2"        ) ; SWire_Tl208_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SWire_Tl208_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Tl208_P2"   ) , SWire_Tl208_h_e_energy_P2       );
		TH1F * SWire_Bi214_h_e_energy_P2       = (TH1F*) hcoll->Find( "SWire_Bi214_h_min_e_energy_P2"       )->Clone( "SWire_Bi214_h_e_energy_P2"        ) ; SWire_Bi214_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SWire_Bi214_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Bi214_P2"   ) , SWire_Bi214_h_e_energy_P2       );
		TH1F * SFoil_Bi214_h_e_energy_P2       = (TH1F*) hcoll->Find( "SFoil_Bi214_h_min_e_energy_P2"       )->Clone( "SFoil_Bi214_h_e_energy_P2"        ) ; SFoil_Bi214_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SFoil_Bi214_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Bi214_P2"   ) , SFoil_Bi214_h_e_energy_P2       );
		TH1F * SWire_Pb214_h_e_energy_P2       = (TH1F*) hcoll->Find( "SWire_Pb214_h_min_e_energy_P2"       )->Clone( "SWire_Pb214_h_e_energy_P2"        ) ; SWire_Pb214_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SWire_Pb214_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SWire_Pb214_P2"   ) , SWire_Pb214_h_e_energy_P2       );
		TH1F * SFoil_Pb214_h_e_energy_P2       = (TH1F*) hcoll->Find( "SFoil_Pb214_h_min_e_energy_P2"       )->Clone( "SFoil_Pb214_h_e_energy_P2"        ) ; SFoil_Pb214_h_e_energy_P2       -> Add ( (TH1F*) hcoll->Find( "SFoil_Pb214_h_max_e_energy_P2"       )); e_energy -> AddComponent( DataManagement::FindComponent( "SFoil_Pb214_P2"   ) , SFoil_Pb214_h_e_energy_P2       );
		TH1F * FeShield_Bi214_h_e_energy       = (TH1F*) hcoll->Find( "FeShield_Bi214_h_min_e_energy"       )->Clone( "FeShield_Bi214_h_e_energy"        ) ; FeShield_Bi214_h_e_energy       -> Add ( (TH1F*) hcoll->Find( "FeShield_Bi214_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "FeShield_Bi214"   ) , FeShield_Bi214_h_e_energy       );
		TH1F * FeShield_Tl208_h_e_energy       = (TH1F*) hcoll->Find( "FeShield_Tl208_h_min_e_energy"       )->Clone( "FeShield_Tl208_h_e_energy"        ) ; FeShield_Tl208_h_e_energy       -> Add ( (TH1F*) hcoll->Find( "FeShield_Tl208_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "FeShield_Tl208"   ) , FeShield_Tl208_h_e_energy       );
		TH1F * FeShield_Ac228_h_e_energy       = (TH1F*) hcoll->Find( "FeShield_Ac228_h_min_e_energy"       )->Clone( "FeShield_Ac228_h_e_energy"        ) ; FeShield_Ac228_h_e_energy       -> Add ( (TH1F*) hcoll->Find( "FeShield_Ac228_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "FeShield_Ac228"   ) , FeShield_Ac228_h_e_energy       );	
		TH1F * CuTower_Co60_h_e_energy         = (TH1F*) hcoll->Find( "CuTower_Co60_h_min_e_energy"         )->Clone( "CuTower_Co60_h_e_energy"          ) ; CuTower_Co60_h_e_energy         -> Add ( (TH1F*) hcoll->Find( "CuTower_Co60_h_max_e_energy"         )); e_energy -> AddComponent( DataManagement::FindComponent( "CuTower_Co60"     ) , CuTower_Co60_h_e_energy         );
		TH1F * Air_Bi214_h_e_energy_P1         = (TH1F*) hcoll->Find( "Air_Bi214_h_min_e_energy_P1"         )->Clone( "Air_Bi214_h_e_energy_P1"          ) ; Air_Bi214_h_e_energy_P1         -> Add ( (TH1F*) hcoll->Find( "Air_Bi214_h_max_e_energy_P1"         )); e_energy -> AddComponent( DataManagement::FindComponent( "Air_Bi214_P1"     ) , Air_Bi214_h_e_energy_P1         );
		TH1F * Air_Pb214_h_e_energy_P1         = (TH1F*) hcoll->Find( "Air_Pb214_h_min_e_energy_P1"         )->Clone( "Air_Pb214_h_e_energy_P1"          ) ; Air_Pb214_h_e_energy_P1         -> Add ( (TH1F*) hcoll->Find( "Air_Pb214_h_max_e_energy_P1"         )); e_energy -> AddComponent( DataManagement::FindComponent( "Air_Pb214_P1"     ) , Air_Pb214_h_e_energy_P1         );
		TH1F * Air_Tl208_h_e_energy_P1         = (TH1F*) hcoll->Find( "Air_Tl208_h_min_e_energy_P1"         )->Clone( "Air_Tl208_h_e_energy_P1"          ) ; Air_Tl208_h_e_energy_P1         -> Add ( (TH1F*) hcoll->Find( "Air_Tl208_h_max_e_energy_P1"         )); e_energy -> AddComponent( DataManagement::FindComponent( "Air_Tl208_P1"     ) , Air_Tl208_h_e_energy_P1         );
		TH1F * PMT_Bi214_h_e_energy            = (TH1F*) hcoll->Find( "PMT_Bi214_h_min_e_energy"            )->Clone( "PMT_Bi214_h_e_energy"             ) ; PMT_Bi214_h_e_energy            -> Add ( (TH1F*) hcoll->Find( "PMT_Bi214_h_max_e_energy"            )); e_energy -> AddComponent( DataManagement::FindComponent( "PMT_Bi214"        ) , PMT_Bi214_h_e_energy            );
		TH1F * PMT_Tl208_h_e_energy            = (TH1F*) hcoll->Find( "PMT_Tl208_h_min_e_energy"            )->Clone( "PMT_Tl208_h_e_energy"             ) ; PMT_Tl208_h_e_energy            -> Add ( (TH1F*) hcoll->Find( "PMT_Tl208_h_max_e_energy"            )); e_energy -> AddComponent( DataManagement::FindComponent( "PMT_Tl208"        ) , PMT_Tl208_h_e_energy            );
		TH1F * PMT_Ac228_h_e_energy            = (TH1F*) hcoll->Find( "PMT_Ac228_h_min_e_energy"            )->Clone( "PMT_Ac228_h_e_energy"             ) ; PMT_Ac228_h_e_energy            -> Add ( (TH1F*) hcoll->Find( "PMT_Ac228_h_max_e_energy"            )); e_energy -> AddComponent( DataManagement::FindComponent( "PMT_Ac228"        ) , PMT_Ac228_h_e_energy            );
		TH1F * PMT_K40_h_e_energy              = (TH1F*) hcoll->Find( "PMT_K40_h_min_e_energy"              )->Clone( "PMT_K40_h_e_energy"               ) ; PMT_K40_h_e_energy              -> Add ( (TH1F*) hcoll->Find( "PMT_K40_h_max_e_energy"              )); e_energy -> AddComponent( DataManagement::FindComponent( "PMT_K40"          ) , PMT_K40_h_e_energy              );
		TH1F * ScintInn_K40_h_e_energy         = (TH1F*) hcoll->Find( "ScintInn_K40_h_min_e_energy"         )->Clone( "ScintInn_K40_h_e_energy"          ) ; ScintInn_K40_h_e_energy         -> Add ( (TH1F*) hcoll->Find( "ScintInn_K40_h_max_e_energy"         )); e_energy -> AddComponent( DataManagement::FindComponent( "ScintInn_K40"     ) , ScintInn_K40_h_e_energy         );
		TH1F * ScintOut_K40_h_e_energy         = (TH1F*) hcoll->Find( "ScintOut_K40_h_min_e_energy"         )->Clone( "ScintOut_K40_h_e_energy"          ) ; ScintOut_K40_h_e_energy         -> Add ( (TH1F*) hcoll->Find( "ScintOut_K40_h_max_e_energy"         )); e_energy -> AddComponent( DataManagement::FindComponent( "ScintOut_K40"     ) , ScintOut_K40_h_e_energy         );
		TH1F * ScintPet_K40_h_e_energy         = (TH1F*) hcoll->Find( "ScintPet_K40_h_min_e_energy"         )->Clone( "ScintPet_K40_h_e_energy"          ) ; ScintPet_K40_h_e_energy         -> Add ( (TH1F*) hcoll->Find( "ScintPet_K40_h_max_e_energy"         )); e_energy -> AddComponent( DataManagement::FindComponent( "ScintPet_K40"     ) , ScintPet_K40_h_e_energy         );
		TH1F * MuMetal_Pa234m_h_e_energy       = (TH1F*) hcoll->Find( "MuMetal_Pa234m_h_min_e_energy"       )->Clone( "MuMetal_Pa234m_h_e_energy"        ) ; MuMetal_Pa234m_h_e_energy       -> Add ( (TH1F*) hcoll->Find( "MuMetal_Pa234m_h_max_e_energy"       )); e_energy -> AddComponent( DataManagement::FindComponent( "MuMetal_Pa234m"   ) , MuMetal_Pa234m_h_e_energy       );	
		TH1F * Cd116_2b2n_m4_h_e_energy        = (TH1F*) hcoll->Find( "Cd116_2b2n_m4_h_min_e_energy"        )->Clone( "Cd116_2b2n_m4_h_e_energy"         ) ; Cd116_2b2n_m4_h_e_energy        -> Add ( (TH1F*) hcoll->Find( "Cd116_2b2n_m4_h_max_e_energy"        )); e_energy -> AddComponent( DataManagement::FindComponent( "Cd116_2b2n_m4"    ) , Cd116_2b2n_m4_h_e_energy        );
	...
	e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); e_energy -> SetLogScale(kTRUE);
    e_energy -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	...
	min_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_track -> SetLogScale(kTRUE);
	min_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	min_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); min_e_curv -> SetLogScale(kTRUE);
	min_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	...
	max_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_track -> SetLogScale(kTRUE);
	max_e_track  -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	max_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); max_e_curv -> SetLogScale(kTRUE);
	max_e_curv   -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  );
	...
	pInt         -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf"  ); pInt -> SetLogScale(kTRUE);
	pInt         -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	

	min_e_vtx_s -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	
	max_e_vtx_s -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	
	min_e_vtx_z -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	
	max_e_vtx_z -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	

	vtx_dr -> SetLogScale(kTRUE); vtx_dr -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf" );	
	vtx_dz -> SetLogScale(kTRUE); vtx_dz -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print("FitTwoElectronColdWarm_HSD.pdf)" );	
	...
	tot_e_energy -> PrintQuality();
	e_energy     -> PrintQuality();
    min_e_energy -> PrintQuality();
    min_e_track  -> PrintQuality();
    min_e_curv   -> PrintQuality();
    max_e_energy -> PrintQuality();
    max_e_track  -> PrintQuality();
    max_e_curv   -> PrintQuality();
    cosTheta     -> PrintQuality();    	
    pInt         -> PrintQuality();
   	min_e_vtx_s -> PrintQuality();
   	min_e_vtx_z -> PrintQuality();
   	max_e_vtx_s -> PrintQuality();
   	max_e_vtx_z -> PrintQuality();
