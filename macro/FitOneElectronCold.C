{
	...
	//
	//////////////////////////////////////////////////////////////////////////////	
	DataManagement::AddParameter( new Parameter( "Cd116_K40_cold"    , "Cd116_K40_cold"    , 0 , 6.59868e-03 , 0.001 ) ); //DataManagement::FindParameter( "Cd116_K40_cold"     ) -> SetFix();
	DataManagement::AddParameter( new Parameter( "Cd116_Pa234m_cold" , "Cd116_Pa234m_cold" , 1 , 1.09730e-03 , 0.001 ) ); //DataManagement::FindParameter( "Cd116_Pa234m_cold"  ) -> SetFix();
	DataManagement::AddParameter( new Parameter( "SFoil_Bi210_P1"    , "SFoil_Bi210_P1"    , 2 , 5.24987e-01 , 0.001 ) ); //DataManagement::FindParameter( "SFoil_Bi210_P1" ) -> SetFix();
	DataManagement::AddParameter( new Parameter( "SFoil_Bi210_P2"    , "SFoil_Bi210_P2"    , 3 , 4.44764e-01 , 0.001 ) ); //DataManagement::FindParameter( "SFoil_Bi210_P2" ) -> SetFix();
	...
	DataManagement::AddParameter( new Parameter( "cRn"               , "cRn"               , 5 , 9.99763e-01 , 0.001 ) ); //DataManagement::FindParameter( "cRn"  ) -> SetFix(); 
	DataManagement::AddParameter( new Parameter( "cInt"              , "cInt"              , 6 , 9.99999e-01 , 0.001 ) ); //DataManagement::FindParameter( "cInt" ) -> SetFix();    
	DataManagement::AddParameter( new Parameter( "cExt"              , "cExt"              , 7 , 9.99995e-01 , 0.001 ) ); //DataManagement::FindParameter( "cExt" ) -> SetFix();
	//////////////////////////////////////////////////////////////////////////////
	//	
	// bb2nu
	//
	...
	e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,".eps");
	e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,".eps");
	
	e_energy_P1_cold -> SetLogScale(kTRUE); e_energy_P1_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,"_log.eps");
	e_energy_P2_cold -> SetLogScale(kTRUE); e_energy_P2_cold -> Draw(); (TPad*)gROOT->GetSelectedPad()->Print(0,"_log.eps");
