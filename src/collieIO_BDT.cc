...
int main(int argc, char* argv[]) {
    ...
    TH1D * Cd116_Pa234m_cold = (TH1D*) infile->Get( "Cd116_Pa234m_MVA_BDT"   ) -> Clone( "Cd116_Pa234m_cold" ) ; Cd116_Pa234m_cold -> Sumw2() ; Cd116_Pa234m_cold -> Scale( 27.6202   / Cd116_Pa234m_cold -> Integral() ); bkgdNames.push_back( "Cacca_1" ); vbkgd.push_back( Cd116_Pa234m_cold );
    TH1D * Cd116_Pa234m_warm = (TH1D*) infile->Get( "Cd116_Pa234m_MVA_BDT"   ) -> Clone( "Cd116_Pa234m_warm" ) ; Cd116_Pa234m_warm -> Sumw2() ; Cd116_Pa234m_warm -> Scale( 72.5556   / Cd116_Pa234m_warm -> Integral() ); bkgdNames.push_back( "Cacca_2" ); vbkgd.push_back( Cd116_Pa234m_warm );
    TH1D * SFoil_Bi210_warm  = (TH1D*) infile->Get( "SFoil_Bi210_MVA_BDT"    ) -> Clone( "SFoil_Bi210_warm"  ) ; SFoil_Bi210_warm  -> Sumw2() ; SFoil_Bi210_warm  -> Scale( 23.2433   / SFoil_Bi210_warm  -> Integral() ); bkgdNames.push_back( "Cacca_3" ); vbkgd.push_back( SFoil_Bi210_warm  );    
